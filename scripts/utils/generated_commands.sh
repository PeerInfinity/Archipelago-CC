#!/bin/bash
# Generated by generate_all_templates.sh on 2026-02-27T21:19:27+00:00
#
# Configuration:
...
python scripts/test/test-world-generator.py --include-list Metamath.yaml --phase generate-test-worlds --seed 1 --canonical-seed 1
python -m world_generator frontend/presets/metamath/AP_05594871498841892311/AP_05594871498841892311_rules.json -o worlds/metamath_canth_worldgen --game-name "Metamath Canth WorldGen" --force --canonical-seed 1
python -m world_generator frontend/presets/metamath/AP_35931773795037525048/AP_35931773795037525048_rules.json -o worlds/metamath_wilth_worldgen --game-name "Metamath Wilth WorldGen" --force --canonical-seed 1
...
python -m world_generator frontend/presets/metamath_vanilla/AP_01043188731678011336/AP_01043188731678011336_rules.json -o worlds/metamath_canth_vanilla_worldgen --game-name "Metamath Canth Vanilla WorldGen" --force --canonical-seed 1
python -m world_generator frontend/presets/metamath_vanilla/AP_84719271504320872445/AP_84719271504320872445_rules.json -o worlds/metamath_wilth_vanilla_worldgen --game-name "Metamath Wilth Vanilla WorldGen" --force --canonical-seed 1
