#!/bin/bash
# Generated by generate_all_templates.sh on 2026-03-09T05:16:28+00:00
#
# Configuration:
...
python -m world_generator frontend/presets/jta_vanilla/AP_14089154938208861744/AP_14089154938208861744_rules.json -o worlds/jta_vanilla_worldgen --game-name "Journey to Ascension Vanilla WorldGen" --force --canonical-seed 1
python scripts/test/test-world-generator.py --include-list "Journey to Ascension.yaml" --phase generate-test-worlds --seed 1 --canonical-seed 1
...
python Generate.py --weights_file_path "Templates/Journey to Ascension Vanilla WorldGen.yaml" --multi 1 --seed 1
python Generate.py --weights_file_path "Templates/Journey to Ascension WorldGen.yaml" --multi 1 --seed 1
