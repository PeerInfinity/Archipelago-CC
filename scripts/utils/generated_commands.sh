#!/bin/bash
# Generated by generate_all_templates.sh on 2026-04-04T05:23:11+00:00
#
# Configuration:
...
python scripts/test/test-world-generator.py --include-list "Mega Man 3.yaml" --phase generate-test-worlds --seed 1 --canonical-seed 1
