 ...
 *   node scripts/test/generate-omsi-substrate-test-preset.mjs --out-dir /tmp/scratch
 *
...
const GENERATOR = 'scripts/test/generate-omsi-substrate-test-preset.mjs';
const SEED = 1;
...
async function buildAndWrite({ engine, substrateRegistry, mergeSubstrateItemLib, DEFAULT_ITEMS,
    ...
    const { outDir } = resolvePresetOutDir({ repoRoot, gameId: gameId, seedId: SEED_ID });
