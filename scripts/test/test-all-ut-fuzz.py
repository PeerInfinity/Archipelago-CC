...
def main():
    ...
    # When prefer_native_ut is True (hybrid mode), use the new tracking-mode-config.json system
    ...
    if args.prefer_native_ut and args.ut_version not in ("original", "pickle"):
