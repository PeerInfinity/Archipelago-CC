...
def generate_ut_comparison_markdown(chart_data: List[Dict[str, Any]],
    ...
    md_content += "**Note:** The game links will only work if the `sphere_log_ut.jsonl` files are present in the preset directories. "
    md_content += "These files are generated by the `.github/workflows/generate-sphere-logs-ut.yml` workflow, but they are erased by any other script that updates the preset directory. "
    md_content += "The files are not guaranteed to currently be present.\n\n"
