 ...
 * Run: node scripts/procgen/check-maze-consumable-tiles.mjs
 * @ci-box V3b adopted this script's NAME, not its RUN: its fixture `maze_consumable_test` is regenerated by hand and NOT committed, so a checkout has nothing for it to drive.
