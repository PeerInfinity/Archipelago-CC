...
takeBoxLockOrExit({ name: 'check-seedling-save-stamp.mjs', kind: WIN ? 'windows' : 'browser' });
...
try {
    driverOut = channel.run([
        '--plan', channel.path('savestamp-plan.json'),
        '--out', channel.path('savestamp-results.json'),
