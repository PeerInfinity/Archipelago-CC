 ...
 * game playing itself). check-bounce-embed.mjs is the template;
 * check-runner-bot.mjs supplies the bot-driving surface.
 *
 ...
 * Run: node scripts/procgen/check-runner-embed.mjs
...
takeBoxLockOrExit({ name: 'check-runner-embed.mjs', kind: 'browser' });
