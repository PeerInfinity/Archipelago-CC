/**
 * check-runner-smoke — **VERIFIES THAT A GENERATED RUNNER WORLD BOOTS,
 ...
 * Run:
 *
 *     node scripts/procgen/check-runner-smoke.mjs
 *
...
takeBoxLockOrExit({ name: 'check-runner-smoke.mjs', kind: 'browser' });
