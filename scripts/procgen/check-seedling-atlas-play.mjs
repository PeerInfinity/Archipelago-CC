 ...
 * check-seedling-wasm-bridge.mjs.
 *
 * Run: node scripts/procgen/check-seedling-atlas-play.mjs [--host=http://localhost:8000]
 ...
 * gate nobody runs.
 *
 *   node scripts/procgen/check-seedling-atlas-play.mjs --host=http://localhost:8129
 */
