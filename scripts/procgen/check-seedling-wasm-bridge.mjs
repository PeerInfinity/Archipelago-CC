 ...
 *
 * Run: node scripts/procgen/check-seedling-wasm-bridge.mjs [--host=http://localhost:8000]
 ...
 * gate nobody runs.
 *
 *   node scripts/procgen/check-seedling-wasm-bridge.mjs --host=http://localhost:8129
 */
