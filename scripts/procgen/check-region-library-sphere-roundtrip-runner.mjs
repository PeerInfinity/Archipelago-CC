 ...
 * of check-region-library-sphere-roundtrip.mjs). Proves that a sphere world mixing
 ...
 *   node scripts/procgen/check-region-library-sphere-roundtrip-runner.mjs
...
const py = generatePythonOrExit('check-region-library-sphere-roundtrip-runner.mjs');
