#!/usr/bin/env node
/**
 * check-seedling-ap-placement — **AP'S PLACEMENT, DELIVERED INTO THE LIVE
 ...
 * ~2.2 s, and `check-seedling-bot-differential.mjs:500-507` has said so since
 ...
 *
 * ⛓ THE THREE NUMBERS ARE `check-seedling-bot-differential.mjs:500-507`'s,
 ...
 * (`check-seedling-wasm-bridge.mjs:80-86`) calls it *"the flow a user takes
