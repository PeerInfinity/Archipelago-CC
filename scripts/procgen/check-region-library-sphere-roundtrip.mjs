 ...
 * check-region-library-roundtrip.mjs). Proves that a sphere world mixing a
 ...
 *   node scripts/procgen/check-region-library-sphere-roundtrip.mjs
...
const py = generatePythonOrExit('check-region-library-sphere-roundtrip.mjs');
