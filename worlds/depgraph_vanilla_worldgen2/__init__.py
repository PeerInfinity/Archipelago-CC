"""
DepGraph Vanilla WorldGen2 world implementation for Archipelago.
...
from .Items import item_table, ItemData, DepGraphVanillaWorldGen2Item
from .Locations import location_table, DepGraphVanillaWorldGen2Location
from .Options import DepGraphVanillaWorldGen2Options
...
class DepGraphVanillaWorldGen2Web(WebWorld):
    """Web interface for DepGraph Vanilla WorldGen2."""
    theme = "grass"
...
class DepGraphWorld(RuleWorldMixin, World):
    ...
    game: ClassVar[str] = "DepGraph Vanilla WorldGen2"
    web: ClassVar[WebWorld] = DepGraphVanillaWorldGen2Web()

    options_dataclass = DepGraphVanillaWorldGen2Options
    options: DepGraphVanillaWorldGen2Options
    ...
    preset_label: ClassVar[str] = "tech_tree v"
            ...
            if classification_counts:
                ...
                for classification_name, class_count in classification_counts.items():
                    ...
                    for _ in range(class_count):
                        item = DepGraphVanillaWorldGen2Item(
                            item_name,
                            classification,
                            item_data.id,
                            self.player
    ...
    def create_item(self, name: str) -> Item:
        ...
        item = DepGraphVanillaWorldGen2Item(name, data.classification, data.id, self.player)
        return item
