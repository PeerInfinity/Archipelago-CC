...
from .Items import item_table, MegaMan2WorldGenItem
...
class MegaMan2WorldGenWorld(RuleWorldMixin, World):
    """
    Mega Man 2 WorldGen for Archipelago.
    ...
    def __init__(self, multiworld: "MultiWorld", player: int):
        ...
        self.web = types.SimpleNamespace(theme='partyTime', tutorials=[{'name': 'Multiworld Setup Guide', 'description': 'A guide to setting up the Mega Man 2 randomizer connected to an Archipelago Multiworld.', 'language': 'English', 'file_name': 'setup_en.md', 'link': 'setup/en', 'authors': ['Silvris']}])
    ...
    def create_item(self, name: str) -> Item:
        ...
        return MegaMan2WorldGenItem(name, data.classification, data.id, self.player)
