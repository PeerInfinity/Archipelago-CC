...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        And(Or(Has('Chaingun'), Has('Shotgun'), Has('Super Shotgun')), Has('The Gantlet (MAP03)'))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Focus (MAP04) Main", player),
        And(Or(Has('Chaingun'), Has('Shotgun'), Has('Super Shotgun')), Has('The Focus (MAP04)'))
    )
    ...
    world.set_rule(
        ...
        And(And(Has('Shotgun'), Has('The Crusher (MAP06)')), Or(Has('Chaingun'), Has('Plasma gun')))
    )
    ...
    world.set_rule(
        ...
        And(And(Has('Chaingun'), Has('Shotgun'), Has('Super Shotgun'), Has('Tricks and Traps (MAP08)')), Or(Has('BFG9000'), Has('Plasma gun'), Has('Rocket launcher')))
    )
    ...
    world.set_rule(
        ...
        And(And(Has('Chaingun'), Has('Circle of Death (MAP11)'), Has('Shotgun'), Has('Super Shotgun')), Or(Has('BFG9000'), Has('Plasma gun'), Has('Rocket launcher')))
    )
    ...
    world.set_rule(
        ...
        And(And(Has('Chaingun'), Has('Downtown (MAP13)'), Has('Shotgun'), Has('Super Shotgun')), Or(Has('BFG9000'), Has('Plasma gun'), Has('Rocket launcher')))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Inmost Dens (MAP14) Main", player),
        And(And(Has('Chaingun'), Has('Shotgun'), Has('Super Shotgun'), Has('The Inmost Dens (MAP14)')), Or(Has('BFG9000'), Has('Plasma gun'), Has('Rocket launcher')))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> Industrial Zone (MAP15) Main", player),
        And(And(Has('Chaingun'), Has('Industrial Zone (MAP15)'), Has('Shotgun'), Has('Super Shotgun')), Or(Has('BFG9000'), Has('Plasma gun'), Has('Rocket launcher')))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> Suburbs (MAP16) Main", player),
        And(And(Has('Chaingun'), Has('Shotgun'), Has('Suburbs (MAP16)'), Has('Super Shotgun')), Or(Has('BFG9000'), Has('Plasma gun'), Has('Rocket launcher')))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> Tenements (MAP17) Main", player),
        And(And(Has('Chaingun'), Has('Shotgun'), Has('Super Shotgun'), Has('Tenements (MAP17)')), Or(Has('BFG9000'), Has('Plasma gun'), Has('Rocket launcher')))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Courtyard (MAP18) Main", player),
        And(And(Has('Chaingun'), Has('Shotgun'), Has('Super Shotgun'), Has('The Courtyard (MAP18)')), Or(Has('BFG9000'), Has('Plasma gun'), Has('Rocket launcher')))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Citadel (MAP19) Main", player),
        And(And(Has('Chaingun'), Has('Shotgun'), Has('Super Shotgun'), Has('The Citadel (MAP19)')), Or(Has('BFG9000'), Has('Plasma gun'), Has('Rocket launcher')))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> Gotcha! (MAP20) Main", player),
        And(And(Has('Chaingun'), Has('Gotcha! (MAP20)'), Has('Shotgun'), Has('Super Shotgun')), Or(Has('BFG9000'), Has('Plasma gun'), Has('Rocket launcher')))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Plasma gun'), Has('Shotgun'), Has('Super Shotgun')), Has('The Catacombs (MAP22)'))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> Barrels o' Fun (MAP23) Main", player),
        And(And(Has("Barrels o' Fun (MAP23)"), Has('Chaingun'), Has('Shotgun'), Has('Super Shotgun')), Or(Has('BFG9000'), Has('Plasma gun'), Has('Rocket launcher')))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Chasm (MAP24) Main", player),
        And(Has('BFG9000'), Has('Chaingun'), Has('Plasma gun'), Has('Rocket launcher'), Has('Shotgun'), Has('Super Shotgun'), Has('The Chasm (MAP24)'))
    )
    ...
    world.set_rule(
        ...
        And(Has('BFG9000'), Has('Chaingun'), Has('Plasma gun'), Has('Rocket launcher'), Has('Shotgun'), Has('Super Shotgun'), Has('The Abandoned Mines (MAP26)'))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> Monster Condo (MAP27) Main", player),
        And(Has('BFG9000'), Has('Chaingun'), Has('Monster Condo (MAP27)'), Has('Plasma gun'), Has('Rocket launcher'), Has('Shotgun'), Has('Super Shotgun'))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Spirit World (MAP28) Main", player),
        And(Has('BFG9000'), Has('Chaingun'), Has('Plasma gun'), Has('Rocket launcher'), Has('Shotgun'), Has('Super Shotgun'), Has('The Spirit World (MAP28)'))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Living End (MAP29) Main", player),
        And(Has('BFG9000'), Has('Chaingun'), Has('Plasma gun'), Has('Rocket launcher'), Has('Shotgun'), Has('Super Shotgun'), Has('The Living End (MAP29)'))
    )
    ...
    world.set_rule(
        ...
        And(And(Has('Shotgun'), Has('Super Shotgun')), Or(Has('Chaingun'), Has('Plasma gun')))
    )

    world.set_rule(
        multiworld.get_entrance("The Crusher (MAP06) Main -> The Crusher (MAP06) Blue", player),
        And(Has('Super Shotgun'), Has('The Crusher (MAP06) - Blue keycard'))
    )
    ...
    world.set_rule(
        ...
        And(And(Has('Chaingun'), Has('Shotgun'), Has('Super Shotgun')), Or(Has('BFG9000'), Has('Plasma gun'), Has('Rocket launcher')))
    )
    ...
    world.set_rule(
        ...
        Or(Has('Plasma gun'), Has('Super Shotgun'))
    )

    world.set_rule(
        multiworld.get_entrance("The Factory (MAP12) Main -> The Factory (MAP12) Indoors", player),
        And(And(Has('Chaingun'), Has('Super Shotgun')), Or(Has('BFG9000'), Has('Plasma gun')))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('The Citadel (MAP19) - Blue skull key'), Has('The Citadel (MAP19) - Yellow skull key')), Has('The Citadel (MAP19) - Red skull key'))
    )
    ...
    world.set_rule(
        ...
        And(And(Has('Chaingun'), Has('Nirvana (MAP21) - Yellow skull key'), Has('Super Shotgun')), Or(Has('BFG9000'), Has('Plasma gun')))
    )
    ...
    world.set_rule(
        ...
        And(Has('Nirvana (MAP21) - Blue skull key'), Has('Nirvana (MAP21) - Red skull key'))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('BFG9000'), Has('Plasma gun'), Has('Rocket launcher')), Has('Bloodfalls (MAP25) - Blue skull key'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Chaingun'), Has('Shotgun'), Has('Super Shotgun'))
    )
    ...
    world.set_rule(
        ...
        And(Has('BFG9000'), Has('Chaingun'), Has('Plasma gun'), Has('Rocket launcher'), Has('Shotgun'), Has('Super Shotgun'))
    )
