"""
Runner Sphere WorldGen world implementation for Archipelago.
...
from .Items import item_table, ItemData, RunnerSphereWorldGenItem
from .Locations import location_table, RunnerSphereWorldGenLocation
from .Options import RunnerSphereWorldGenOptions
...
class RunnerSphereWorldGenWeb(WebWorld):
    """Web interface for Runner Sphere WorldGen."""
    theme = "ocean"
...
class ProcgenMazeWorld(RuleWorldMixin, World):
    ...
    game: ClassVar[str] = "Runner Sphere WorldGen"
    web: ClassVar[WebWorld] = RunnerSphereWorldGenWeb()

    options_dataclass = RunnerSphereWorldGenOptions
    options: RunnerSphereWorldGenOptions
    ...
    item_name_groups: ClassVar[Dict[str, frozenset]] = {
        "Everything": frozenset(["Blue Platforms", "Double Jump", "Victory"]),
    }
    ...
    canonical_placements: ClassVar[Dict[str, str]] = {
        "region_2_2__loc_0": "Blue Platforms",
        "region_2_3__loc_0": "Double Jump",
    ...
    canonical_placement_advancements: ClassVar[Dict[str, bool]] = {
        "region_2_2__loc_0": True,
        "region_2_3__loc_0": True,
    ...
    def create_item(self, name: str) -> Item:
        ...
        item = RunnerSphereWorldGenItem(name, data.classification, data.id, self.player)
        return item
