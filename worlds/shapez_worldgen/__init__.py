"""
shapez world implementation for Archipelago.
...
from .Items import item_table, shapezItem
...
class ShapezWorld(RuleWorldMixin, World):
    ...
    game: ClassVar[str] = "shapez"
    web: ClassVar[WebWorld] = shapezWeb()
    ...
    def create_item(self, name: str) -> Item:
        ...
        return shapezItem(name, data.classification, data.id, self.player)
