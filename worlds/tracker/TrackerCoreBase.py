...
class TrackerCoreBase():
    ...
    def run_generator(self, slot_data: dict | None = None, override_yaml_path: str | None = None, super_override_yaml_path: str|None = None):
        ...
        try:
            ...
            # [fork hook] Allow subclasses to inject a seed number for deterministic
            # generation (used by TrackerCore's original_seeded mode + fuzz tests).
            # This is the ONLY fork edit in this otherwise-pristine upstream file.
