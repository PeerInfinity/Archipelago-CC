"""
Game options for Coding Adventure Vanilla WorldGen2.
...
@dataclass
class CodingAdventureVanillaWorldGen2Options(PerGameCommonOptions):
    """Options for Coding Adventure Vanilla WorldGen2."""
