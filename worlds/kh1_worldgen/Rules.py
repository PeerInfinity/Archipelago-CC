...
from rule_builder import True_, False_, Arithmetic, Compare, CountItem, False_, Has, HasAll, HasAllCounts, HasAny, HasGroup, True_
...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        (Compare(Arithmetic(True_(), "+", True_()), ">=", 15)) & (((False_()) & (Has("High Jump", 2))) | (Has("Green Trinity")))
    )
