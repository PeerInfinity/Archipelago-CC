...
from rule_builder import True_, False_, Arithmetic, Compare, CountItem, False_, Has, HasAll, HasAllCounts, HasAny, HasGroup, MinValue, True_
...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        ((True_()) & (HasAll('Bambi', 'Dumbo', 'Genie', 'Mushu', 'Simba', 'Tinker Bell'))) & (((True_()) & (Has("Progressive Glide"))) | (Has("High Jump"))) & (Has("Monstro"))
    )
    ...
    world.set_rule(
        ...
        (True_()) & (HasAll('Aero Arts', 'Blizzard Arts', 'Cure Arts', 'Fire Arts', 'Gravity Arts', 'Stop Arts', 'Thunder Arts')) & (HasAllCounts({'Progressive Aero': 1, 'Progressive Blizzard': 1, 'Progressive Cure': 1, 'Progressive Fire': 1, 'Progressive Gravity': 1, 'Progressive Stop': 1, 'Progressive Thunder': 1}))
    )
    ...
    world.set_rule(
        ...
        (Compare(Arithmetic(MinValue(CountItem("Orichalcum"), 9), "+", MinValue(CountItem("Mythril"), 9)), ">=", 15)) & (((False_()) & (Has("High Jump", 2))) | (Has("Green Trinity")))
    )
    ...
    world.set_rule(
        ...
        ((True_()) & (HasAny('High Jump', 'Progressive Glide'))) | (False_()) | (HasAll('High Jump', 'Progressive Glide'))
    )
    ...
    world.set_rule(
        ...
        ((True_()) & ((Has("High Jump")) | (Has("Progressive Glide")))) | (False_()) | (HasAll('High Jump', 'Progressive Glide'))
    )
    ...
    world.set_rule(
        ...
        ((False_()) & (Has("Combo Master"))) | ((False_()) & ((HasAll('Combo Master', 'High Jump')) | (Has("High Jump", 2)) | (Has("Progressive Glide")))) | ((True_()) & (Has("High Jump", 3))) | (HasAll('High Jump', 'Progressive Glide'))
    )
    ...
    world.set_rule(
        ...
        ((False_()) & ((Has("Combo Master")) | (Has("High Jump")) | (Has("Progressive Glide")))) | (False_()) | (HasAll('High Jump', 'Progressive Glide'))
    )
    ...
    world.set_rule(
        ...
        (True_()) | (False_()) | (HasAny('High Jump', 'Progressive Glide'))
    )
    ...
    world.set_rule(
        ...
        ((((True_()) & (False_()) & (Has("Forget-Me-Not"))) | ((True_()) & (Has("Halloween Town", 2))) | (Has("Forget-Me-Not"))) & ((True_()) | (True_()) | (True_()) | (Has("Crabclaw")))) & ((((True_()) & (True_()) & (Has("Forget-Me-Not"))) | ((True_()) & (Has("Halloween Town", 2))) | (Has("Jack-In-The-Box"))) & ((True_()) | (True_()) | (True_()) | (Has("Crabclaw")))) & (((False_()) & (HasAny('High Jump', 'Progressive Glide'))) | ((True_()) & (Has("High Jump", 3))) | (((False_()) & (Has("High Jump", 2))) | (HasAll('High Jump', 'Progressive Glide'))) | (Has("Progressive Fire")))
    )
    ...
    world.set_rule(
        ...
        (((HasGroup("Magic")) & (Has("Dumbo"))) & (False_())) | ((True_()) & ((Has("High Jump")) | (Has("Progressive Glide")))) | (HasAll('High Jump', 'Progressive Glide'))
    )
    ...
    world.set_rule(
        ...
        ((((True_()) & (False_()) & (Has("Forget-Me-Not"))) | ((True_()) & (Has("Halloween Town", 2))) | (Has("Forget-Me-Not"))) & ((True_()) | (True_()) | (True_()) | (Has("Crabclaw")))) & ((((True_()) & (True_()) & (Has("Forget-Me-Not"))) | ((True_()) & (Has("Halloween Town", 2))) | (Has("Jack-In-The-Box"))) & ((True_()) | (True_()) | (True_()) | (Has("Crabclaw")))) & (((False_()) & (HasAny('High Jump', 'Progressive Glide'))) | ((True_()) & (Has("High Jump", 3))) | (((False_()) & (Has("High Jump", 2))) | (HasAll('High Jump', 'Progressive Glide'))) | (Has("Progressive Fire"))) & ((True_()) | (False_()) | (Has("Progressive Glide")))
    )

    world.set_rule(
        multiworld.get_location("Halloween Town Oogie's Manor Upper Iron Cage Chest", player),
        ((((True_()) & (False_()) & (Has("Forget-Me-Not"))) | ((True_()) & (Has("Halloween Town", 2))) | (Has("Forget-Me-Not"))) & ((True_()) | (True_()) | (True_()) | (Has("Crabclaw")))) & ((((True_()) & (True_()) & (Has("Forget-Me-Not"))) | ((True_()) & (Has("Halloween Town", 2))) | (Has("Jack-In-The-Box"))) & ((True_()) | (True_()) | (True_()) | (Has("Crabclaw")))) & (((False_()) & (HasAny('High Jump', 'Progressive Glide'))) | ((True_()) & (Has("High Jump", 3))) | (((False_()) & (Has("High Jump", 2))) | (HasAll('High Jump', 'Progressive Glide'))) | (Has("Progressive Fire"))) & ((True_()) | (False_()) | (HasAll('High Jump', 'Progressive Glide')))
    )
    ...
    world.set_rule(
        ...
        ((False_()) & (((HasGroup("Magic")) & (Has("Dumbo"))) | (Has("High Jump", 2)))) | ((False_()) & (HasAll('High Jump', 'Progressive Glide'))) | ((True_()) & (Has("High Jump", 3))) | ((True_()) & (HasAll('Emblem Piece (Chest)', 'Emblem Piece (Flame)', 'Emblem Piece (Fountain)', 'Emblem Piece (Statue)', 'Hollow Bastion')))
    )

    world.set_rule(
        multiworld.get_location("Hollow Bastion Castle Gates Gravity Chest", player),
        (((False_()) & (((HasGroup("Magic")) & (Has("Dumbo"))) | (Has("High Jump", 2))) & (Has("Progressive Glide"))) | ((False_()) & (HasAll('High Jump', 'Progressive Glide'))) | ((True_()) & (Has("High Jump", 3)) & (Has("Progressive Glide"))) | ((True_()) & (HasAll('Emblem Piece (Chest)', 'Emblem Piece (Flame)', 'Emblem Piece (Fountain)', 'Emblem Piece (Statue)', 'Hollow Bastion')))) & (Has("Progressive Gravity"))
    )
    ...
    world.set_rule(
        ...
        ((False_()) & (Has("High Jump", 2))) | ((True_()) & (Has("High Jump", 3))) | ((True_()) & (HasAll('Emblem Piece (Chest)', 'Emblem Piece (Flame)', 'Emblem Piece (Fountain)', 'Emblem Piece (Statue)', 'Hollow Bastion'))) | ((((True_()) & (False_()) & (Has("Forget-Me-Not"))) | ((True_()) & (Has("Hollow Bastion", 2))) | (Has("Theon Vol. 6"))) & ((True_()) | (True_()) | (True_()) | (Has("Crabclaw"))))
    )

    world.set_rule(
        multiworld.get_location("Hollow Bastion Entrance Hall Emblem Piece (Flame)", player),
        (((False_()) & (Has("High Jump", 2))) | ((True_()) & (Has("High Jump", 3))) | ((True_()) & (HasAll('Emblem Piece (Chest)', 'Emblem Piece (Flame)', 'Emblem Piece (Fountain)', 'Emblem Piece (Statue)', 'Hollow Bastion'))) | ((((True_()) & (False_()) & (Has("Forget-Me-Not"))) | ((True_()) & (Has("Hollow Bastion", 2))) | (Has("Theon Vol. 6"))) & ((True_()) | (True_()) | (True_()) | (Has("Crabclaw"))))) & (((True_()) & (Has("High Jump"))) | (False_()) | (Has("Progressive Glide")) | (Has("Progressive Thunder"))) & (Has("Progressive Fire"))
    )
    ...
    world.set_rule(
        ...
        (((False_()) & (Has("High Jump", 2))) | ((True_()) & (Has("High Jump", 3))) | ((True_()) & (HasAll('Emblem Piece (Chest)', 'Emblem Piece (Flame)', 'Emblem Piece (Fountain)', 'Emblem Piece (Statue)', 'Hollow Bastion'))) | ((((True_()) & (False_()) & (Has("Forget-Me-Not"))) | ((True_()) & (Has("Hollow Bastion", 2))) | (Has("Theon Vol. 6"))) & ((True_()) | (True_()) | (True_()) | (Has("Crabclaw"))))) & (Has("Red Trinity"))
    )

    world.set_rule(
        multiworld.get_location("Hollow Bastion Entrance Hall Left of Emblem Door Chest", player),
        (((HasGroup("Magic")) & (Has("Dumbo"))) & ((True_()) & (HasAll('Emblem Piece (Chest)', 'Emblem Piece (Flame)', 'Emblem Piece (Fountain)', 'Emblem Piece (Statue)', 'Hollow Bastion'))) & (False_())) | (Has("High Jump"))
    )
    ...
    world.set_rule(
        ...
        ((False_()) & (((HasGroup("Magic")) & (Has("Dumbo"))) | (Has("High Jump", 2))) & (Has("Progressive Glide"))) | ((False_()) & (HasAll('High Jump', 'Progressive Glide'))) | ((True_()) & (Has("High Jump", 3)) & (Has("Progressive Glide"))) | ((True_()) & (HasAll('Emblem Piece (Chest)', 'Emblem Piece (Flame)', 'Emblem Piece (Fountain)', 'Emblem Piece (Statue)', 'Hollow Bastion')))
    )
    ...
    world.set_rule(
        ...
        (((True_()) & (HasAll('Emblem Piece (Chest)', 'Emblem Piece (Flame)', 'Emblem Piece (Fountain)', 'Emblem Piece (Statue)', 'Hollow Bastion'))) & (Has("Progressive Blizzard"))) | ((False_()) & ((Has("Combo Master")) | (Has("High Jump")))) | ((True_()) & (Has("High Jump", 3))) | (False_()) | (Has("Progressive Glide"))
    )
    ...
    world.set_rule(
        ...
        ((False_()) & ((HasAll('Combo Master', 'High Jump')) | (Has("High Jump", 2)))) | (Has("Progressive Glide"))
    )
    ...
    world.set_rule(
        ...
        ((HasAllCounts({'Dodge Roll': 1, 'Leaf Bracer': 1, 'Progressive Cure': 2})) & (True_())) & (True_()) & (((Has("Destiny Islands")) & (Has("Raft Materials", 10))) | ((((True_()) & (Has("Lucky Emblem", 7))) | (Has("End of the World"))) & (Has("Lucky Emblem", 10))))
    )
