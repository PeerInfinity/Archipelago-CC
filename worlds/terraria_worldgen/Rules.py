...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        ((True_()) & (Has("Dryad"))) | (Has("Evil Powder"))
    )
    ...
    world.set_rule(
        ...
        ((True_()) | (Has("Purified Gel"))) & (Has("Blade of Grass")) & (Has("Evil Sword")) & (Has("Fiery Greatsword")) & (Has("Muramasa"))
    )
    ...
    world.set_rule(
        ...
        ((True_()) & (Has("Ocram's Razor"))) | ((True_()) & (Has("Mechanical Eye")))
    )

    world.set_rule(
        multiworld.get_location("The Destroyer", player),
        ((True_()) & (Has("Ocram's Razor"))) | ((True_()) & (Has("Mechanical Worm")))
    )

    world.set_rule(
        multiworld.get_location("Skeletron Prime", player),
        ((True_()) & (Has("Ocram's Razor"))) | ((True_()) & (Has("Mechanical Skull")))
    )
