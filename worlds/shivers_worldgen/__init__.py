...
class ShiversWorldGenWorld(RuleWorldMixin, World):
    """
    Shivers WorldGen for Archipelago.
    ...
    def __init__(self, multiworld: "MultiWorld", player: int):
        ...
        self.web = types.SimpleNamespace(theme='grass', tutorials=[{'name': 'Shivers Setup Guide', 'description': 'A guide to setting up Shivers for Multiworld.', 'language': 'English', 'file_name': 'setup_en.md', 'link': 'setup/en', 'authors': ['GodlFire', 'Cynbel_Terreus']}])
