...
def set_rules(world: "World") -> None:
    ...
    multiworld.get_entrance("To Victory", player).access_rule = \
        lambda state: (True >= state.multiworld.worlds[player].options.ixupi_captures_needed)
    ...
    multiworld.get_entrance("To Beth's Body From Generator", player).access_rule = \
        lambda state: ((((((True) and (state.has('Viewed Norse Stone', player)))) if (state.multiworld.worlds[player].options.puzzle_hints_required) else (True))) and (beths_body_available(state, player)))
    ...
    multiworld.get_entrance("To Clock Chains From Clock Tower Staircase", player).access_rule = \
        lambda state: ((True) if (state.multiworld.worlds[player].options.puzzle_hints_required) else (True))
    ...
    multiworld.get_location("Jukebox", player).access_rule = \
        lambda state: ((((True) if (state.multiworld.worlds[player].options.puzzle_hints_required) else (True))) and (True))
