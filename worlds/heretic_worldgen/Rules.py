...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        And(Or(Has('Dragon Claw'), Has('Ethereal Crossbow')), Has('The Dungeons (E1M2)'))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Gatehouse (E1M3) Main", player),
        And(Or(Has('Dragon Claw'), Has('Ethereal Crossbow')), Has('The Gatehouse (E1M3)'))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Guard Tower (E1M4) Main", player),
        And(Or(Has('Dragon Claw'), Has('Ethereal Crossbow')), Has('The Guard Tower (E1M4)'))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Citadel (E1M5) Main", player),
        And(And(Has('Ethereal Crossbow'), Has('The Citadel (E1M5)')), Or(Has('Dragon Claw'), Has('Gauntlets of the Necromancer')))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Cathedral (E1M6) Main", player),
        And(And(Has('Ethereal Crossbow'), Has('The Cathedral (E1M6)')), Or(Has('Dragon Claw'), Has('Gauntlets of the Necromancer')))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Crypts (E1M7) Main", player),
        And(And(Has('Ethereal Crossbow'), Has('The Crypts (E1M7)')), Or(Has('Dragon Claw'), Has('Gauntlets of the Necromancer')))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> Hell's Maw (E1M8) Main", player),
        And(Has('Dragon Claw'), Has('Ethereal Crossbow'), Has('Gauntlets of the Necromancer'), Has("Hell's Maw (E1M8)"))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Graveyard (E1M9) Main", player),
        And(Has('Dragon Claw'), Has('Ethereal Crossbow'), Has('Gauntlets of the Necromancer'), Has('The Graveyard (E1M9)'))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Dragon Claw'), Has('Ethereal Crossbow')), Has('The Lava Pits (E2M2)'))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The River of Fire (E2M3) Main", player),
        And(Has('Dragon Claw'), Has('Ethereal Crossbow'), Has('The River of Fire (E2M3)'))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Ice Grotto (E2M4) Main", player),
        And(And(Has('Dragon Claw'), Has('Ethereal Crossbow'), Has('The Ice Grotto (E2M4)')), Or(Has('Firemace'), Has('Hellstaff')))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Catacombs (E2M5) Main", player),
        And(And(Has('Dragon Claw'), Has('Ethereal Crossbow'), Has('Gauntlets of the Necromancer'), Has('The Catacombs (E2M5)')), Or(Has('Firemace'), Has('Hellstaff'), Has('Phoenix Rod')))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Labyrinth (E2M6) Main", player),
        And(And(Has('Dragon Claw'), Has('Ethereal Crossbow'), Has('Gauntlets of the Necromancer'), Has('The Labyrinth (E2M6)')), Or(Has('Firemace'), Has('Hellstaff'), Has('Phoenix Rod')))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Great Hall (E2M7) Main", player),
        And(And(Has('Dragon Claw'), Has('Ethereal Crossbow'), Has('Firemace'), Has('Gauntlets of the Necromancer'), Has('The Great Hall (E2M7)')), Or(Has('Hellstaff'), Has('Phoenix Rod')))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Portals of Chaos (E2M8) Main", player),
        And(Has('Dragon Claw'), Has('Ethereal Crossbow'), Has('Firemace'), Has('Gauntlets of the Necromancer'), Has('Hellstaff'), Has('Phoenix Rod'), Has('The Portals of Chaos (E2M8)'))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Glacier (E2M9) Main", player),
        And(And(Has('Dragon Claw'), Has('Ethereal Crossbow'), Has('Firemace'), Has('Gauntlets of the Necromancer'), Has('The Glacier (E2M9)')), Or(Has('Hellstaff'), Has('Phoenix Rod')))
    )
    ...
    world.set_rule(
        ...
        And(Has('Dragon Claw'), Has('Ethereal Crossbow'), Has('Firemace'), Has('Hellstaff'), Has('The Cesspool (E3M2)'))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Confluence (E3M3) Main", player),
        And(And(Has('Dragon Claw'), Has('Ethereal Crossbow'), Has('The Confluence (E3M3)')), Or(Has('Firemace'), Has('Gauntlets of the Necromancer'), Has('Hellstaff'), Has('Phoenix Rod')))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Azure Fortress (E3M4) Main", player),
        And(And(Has('Dragon Claw'), Has('Ethereal Crossbow'), Has('Hellstaff'), Has('The Azure Fortress (E3M4)')), Or(Has('Firemace'), Has('Gauntlets of the Necromancer'), Has('Phoenix Rod')))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Ophidian Lair (E3M5) Main", player),
        And(And(Has('Dragon Claw'), Has('Ethereal Crossbow'), Has('Hellstaff'), Has('The Ophidian Lair (E3M5)')), Or(Has('Firemace'), Has('Gauntlets of the Necromancer'), Has('Phoenix Rod')))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Halls of Fear (E3M6) Main", player),
        And(And(Has('Dragon Claw'), Has('Ethereal Crossbow'), Has('Firemace'), Has('Hellstaff'), Has('The Halls of Fear (E3M6)')), Or(Has('Gauntlets of the Necromancer'), Has('Phoenix Rod')))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Chasm (E3M7) Main", player),
        And(And(Has('Dragon Claw'), Has('Ethereal Crossbow'), Has('Firemace'), Has('Hellstaff'), Has('The Chasm (E3M7)')), Or(Has('Gauntlets of the Necromancer'), Has('Phoenix Rod')))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> D'Sparil's Keep (E3M8) Main", player),
        And(Has("D'Sparil's Keep (E3M8)"), Has('Dragon Claw'), Has('Ethereal Crossbow'), Has('Firemace'), Has('Gauntlets of the Necromancer'), Has('Hellstaff'), Has('Phoenix Rod'))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Aquifer (E3M9) Main", player),
        And(Has('Dragon Claw'), Has('Ethereal Crossbow'), Has('Firemace'), Has('Gauntlets of the Necromancer'), Has('Hellstaff'), Has('Phoenix Rod'), Has('The Aquifer (E3M9)'))
    )
    ...
    world.set_rule(
        ...
        And(Has('The Ice Grotto (E2M4) - Blue key'), Has('The Ice Grotto (E2M4) - Green key'))
    )
