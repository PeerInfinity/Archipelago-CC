...
# Helper functions
def completion_rule(state: "CollectionState", player: int) -> bool:
    goal_levels = Maps.map_names
    goal_levels = (self.all_boss_levels if self.options.goal.value else goal_levels)
    for map_name in goal_levels:
        ...
        if not ([1, 1, 1, 0, 0][(loc['episode'] - 1)]):
            continue
        if not (state.has((map_name + ' - Complete'), player)):
            return False
    return True
...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        And(HasAny('Dragon Claw', 'Ethereal Crossbow'), Has('The Dungeons (E1M2)'))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Gatehouse (E1M3) Main", player),
        And(HasAny('Dragon Claw', 'Ethereal Crossbow'), Has('The Gatehouse (E1M3)'))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Guard Tower (E1M4) Main", player),
        And(HasAny('Dragon Claw', 'Ethereal Crossbow'), Has('The Guard Tower (E1M4)'))
    )
    ...
    world.set_rule(
        ...
        HasAll('Dragon Claw', 'Ethereal Crossbow', 'Gauntlets of the Necromancer', "Hell's Maw (E1M8)")
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Graveyard (E1M9) Main", player),
        HasAll('Dragon Claw', 'Ethereal Crossbow', 'Gauntlets of the Necromancer', 'The Graveyard (E1M9)')
    )
    ...
    world.set_rule(
        ...
        And(HasAny('Dragon Claw', 'Ethereal Crossbow'), Has('The Lava Pits (E2M2)'))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The River of Fire (E2M3) Main", player),
        HasAll('Dragon Claw', 'Ethereal Crossbow', 'The River of Fire (E2M3)')
    )
    ...
    world.set_rule(
        ...
        HasAll('Dragon Claw', 'Ethereal Crossbow', 'Firemace', 'Gauntlets of the Necromancer', 'Hellstaff', 'Phoenix Rod', 'The Portals of Chaos (E2M8)')
    )
    ...
    world.set_rule(
        ...
        HasAll('Dragon Claw', 'Ethereal Crossbow', 'Firemace', 'Hellstaff', 'The Cesspool (E3M2)')
    )
    ...
    world.set_rule(
        ...
        HasAll("D'Sparil's Keep (E3M8)", 'Dragon Claw', 'Ethereal Crossbow', 'Firemace', 'Gauntlets of the Necromancer', 'Hellstaff', 'Phoenix Rod')
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> The Aquifer (E3M9) Main", player),
        HasAll('Dragon Claw', 'Ethereal Crossbow', 'Firemace', 'Gauntlets of the Necromancer', 'Hellstaff', 'Phoenix Rod', 'The Aquifer (E3M9)')
    )
    ...
    world.set_rule(
        ...
        HasAll('The Ice Grotto (E2M4) - Blue key', 'The Ice Grotto (E2M4) - Green key')
    )
