...
class FaxanaduWorldGenWorld(RuleWorldMixin, World):
    """
    Faxanadu WorldGen for Archipelago.
    ...
    def __init__(self, multiworld: "MultiWorld", player: int):
        ...
        self.web = types.SimpleNamespace(theme='dirt', tutorials=[{'name': 'Multiworld Setup Guide', 'description': 'A guide to setting up the Faxanadu randomizer connected to an Archipelago Multiworld', 'language': 'English', 'file_name': 'setup_en.md', 'link': 'setup/en', 'authors': ['Daivuk']}])
