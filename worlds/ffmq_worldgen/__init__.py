...
class FinalFantasyMysticQuestWorldGenWorld(RuleWorldMixin, World):
    ...
    def __init__(self, multiworld: "MultiWorld", player: int):
        ...
        self.web = types.SimpleNamespace(theme='grass', tutorials=[{'name': 'Multiworld Setup Guide', 'description': 'A guide to playing Final Fantasy Mystic Quest with Archipelago.', 'language': 'English', 'file_name': 'setup_en.md', 'link': 'setup/en', 'authors': ['Alchav']}, {'name': 'Multiworld Setup Guide', 'description': 'A guide to playing Final Fantasy Mystic Quest with Archipelago.', 'language': 'Français', 'file_name': 'setup_fr.md', 'link': 'setup/fr', 'authors': ['Artea']}])
