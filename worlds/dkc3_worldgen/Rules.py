...
from rule_builder import True_, False_, And, Arithmetic, CanReachLocation, Has
...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        And(Has('DK Coin', 30), Has('Progressive Boat Upgrade', 3))
    )
    ...
    world.set_rule(
        ...
        Has('Bonus Coin', Arithmetic(15, "*", Arithmetic(0, "+", 1)))
    )

    world.set_rule(
        multiworld.get_entrance("Criss Kross Cliffs", player),
        Has('Bonus Coin', Arithmetic(15, "*", Arithmetic(1, "+", 1)))
    )

    world.set_rule(
        multiworld.get_entrance("Tyrant Twin Tussle", player),
        Has('Bonus Coin', Arithmetic(15, "*", Arithmetic(2, "+", 1)))
    )

    world.set_rule(
        multiworld.get_entrance("Swoopy Salvo", player),
        Has('Bonus Coin', Arithmetic(15, "*", Arithmetic(3, "+", 1)))
    )

    world.set_rule(
        multiworld.get_entrance("Rocket Rush", player),
        Has('Bonus Coin', Arithmetic(15, "*", Arithmetic(4, "+", 1)))
    )
