"""
DepGraph Vanilla WorldGen world implementation for Archipelago.
...
from .Items import item_table, ItemData, DepGraphVanillaWorldGenItem
from .Locations import location_table, DepGraphVanillaWorldGenLocation
from .Options import DepGraphVanillaWorldGenOptions
...
class DepGraphVanillaWorldGenWeb(WebWorld):
    """Web interface for DepGraph Vanilla WorldGen."""
    theme = "grass"
...
class DepGraphWorld(RuleWorldMixin, World):
    ...
    game: ClassVar[str] = "DepGraph Vanilla WorldGen"
    web: ClassVar[WebWorld] = DepGraphVanillaWorldGenWeb()

    options_dataclass = DepGraphVanillaWorldGenOptions
    options: DepGraphVanillaWorldGenOptions
            ...
            if classification_counts:
                ...
                for classification_name, class_count in classification_counts.items():
                    ...
                    for _ in range(class_count):
                        item = DepGraphVanillaWorldGenItem(
                            item_name,
                            classification,
                            item_data.id,
                            self.player
    ...
    def create_item(self, name: str) -> Item:
        ...
        item = DepGraphVanillaWorldGenItem(name, data.classification, data.id, self.player)
        return item
