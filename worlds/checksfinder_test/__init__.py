"""
ChecksFinder Test world implementation for Archipelago.
...
from .Items import item_table, ChecksFinderTestItem
from .Locations import location_table, ChecksFinderTestLocation
from .Options import ChecksFinderTestOptions
...
class ChecksFinderTestWeb(WebWorld):
    """Web interface for ChecksFinder Test."""
    theme = "ocean"
    tutorials = []


class ChecksFinderTestWorld(RuleWorldMixin, World):
    """
    ChecksFinder Test for Archipelago.

    Auto-generated world implementation.
    """

    game: ClassVar[str] = "ChecksFinder Test"
    web: ClassVar[WebWorld] = ChecksFinderTestWeb()

    options_dataclass = ChecksFinderTestOptions
    options: ChecksFinderTestOptions
    ...
    item_name_groups: ClassVar[Dict[str, frozenset]] = {
        "Everything": frozenset(["Map Bombs", "Map Height", "Map Width"]),
    }
    ...
    def create_item(self, name: str) -> Item:
        ...
        return ChecksFinderTestItem(name, data.classification, data.id, self.player)
