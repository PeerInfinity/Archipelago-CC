"""
Coding Adventure Vanilla WorldGen world implementation for Archipelago.
...
from .Items import item_table, ItemData, CodingAdventureVanillaWorldGenItem
from .Locations import location_table, CodingAdventureVanillaWorldGenLocation
from .Options import CodingAdventureVanillaWorldGenOptions
...
class CodingAdventureVanillaWorldGenWeb(WebWorld):
    """Web interface for Coding Adventure Vanilla WorldGen."""
    theme = "ocean"
...
class CodingAdventureWorld(RuleWorldMixin, World):
    ...
    game: ClassVar[str] = "Coding Adventure Vanilla WorldGen"
    web: ClassVar[WebWorld] = CodingAdventureVanillaWorldGenWeb()

    options_dataclass = CodingAdventureVanillaWorldGenOptions
    options: CodingAdventureVanillaWorldGenOptions
            ...
            if classification_counts:
                ...
                for classification_name, class_count in classification_counts.items():
                    ...
                    for _ in range(class_count):
                        item = CodingAdventureVanillaWorldGenItem(
                            item_name,
                            classification,
                            item_data.id,
                            self.player
    ...
    def generate_basic(self) -> None:
        ...
        if victory_location.item is None:
            victory_item = CodingAdventureVanillaWorldGenItem(
                "Victory",
    ...
    def create_item(self, name: str) -> Item:
        ...
        item = CodingAdventureVanillaWorldGenItem(name, data.classification, data.id, self.player)
        if data.hint_text:
