"""
Game options for Coding Adventure Vanilla WorldGen.
...
@dataclass
class CodingAdventureVanillaWorldGenOptions(PerGameCommonOptions):
    """Options for Coding Adventure Vanilla WorldGen."""
