...
from .Items import item_table, BumperStickersWorldGenItem
...
class BumperStickersWorldGenWorld(RuleWorldMixin, World):
    """
    Bumper Stickers WorldGen for Archipelago.
    ...
    def __init__(self, multiworld: "MultiWorld", player: int):
        ...
        self.web = types.SimpleNamespace(theme='stone', tutorials=[{'name': 'Bumper Stickers Setup Guide', 'description': 'A guide to setting up the Archipelago Bumper Stickers software on your computer.', 'language': 'English', 'file_name': 'setup_en.md', 'link': 'setup/en', 'authors': ['KewlioMZX']}])
    ...
    def create_item(self, name: str) -> Item:
        ...
        return BumperStickersWorldGenItem(name, data.classification, data.id, self.player)
