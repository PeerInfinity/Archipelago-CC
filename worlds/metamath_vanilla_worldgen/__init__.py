"""
Metamath Vanilla WorldGen world implementation for Archipelago.
...
from .Items import item_table, ItemData, MetamathVanillaWorldGenItem
from .Locations import location_table, MetamathVanillaWorldGenLocation
from .Options import MetamathVanillaWorldGenOptions
...
class MetamathVanillaWorldGenWeb(WebWorld):
    """Web interface for Metamath Vanilla WorldGen."""
    theme = "grass"
...
class MetamathWorld(RuleWorldMixin, World):
    ...
    game: ClassVar[str] = "Metamath Vanilla WorldGen"
    web: ClassVar[WebWorld] = MetamathVanillaWorldGenWeb()

    options_dataclass = MetamathVanillaWorldGenOptions
    options: MetamathVanillaWorldGenOptions
            ...
            if classification_counts:
                ...
                for classification_name, class_count in classification_counts.items():
                    ...
                    for _ in range(class_count):
                        item = MetamathVanillaWorldGenItem(
                            item_name,
                            classification,
                            item_data.id,
                            self.player
    ...
    def create_item(self, name: str) -> Item:
        ...
        item = MetamathVanillaWorldGenItem(name, data.classification, data.id, self.player)
        if data.hint_text:
