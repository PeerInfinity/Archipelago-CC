"""
MathProof2p2e4 WorldGen world implementation for Archipelago.
...
from .Items import item_table, MathProof2p2e4WorldGenItem
from .Locations import location_table, MathProof2p2e4WorldGenLocation
from .Options import MathProof2p2e4WorldGenOptions
...
class MathProof2p2e4WorldGenWeb(WebWorld):
    """Web interface for MathProof2p2e4 WorldGen."""
    theme = "ocean"
    tutorials = []


class MathProof2p2e4WorldGenWorld(RuleWorldMixin, World):
    """
    MathProof2p2e4 WorldGen for Archipelago.

    Auto-generated world implementation.
    """

    game: ClassVar[str] = "MathProof2p2e4 WorldGen"
    web: ClassVar[WebWorld] = MathProof2p2e4WorldGenWeb()

    options_dataclass = MathProof2p2e4WorldGenOptions
    options: MathProof2p2e4WorldGenOptions
    ...
    def __init__(self, multiworld: "MultiWorld", player: int):
        ...
        self.web = types.SimpleNamespace(theme='ocean', tutorials=[{'name': 'Mathematical Proof Guide', 'description': 'A guide to completing the proof that 2+2=4', 'language': 'English', 'file_name': 'guide_en.md', 'link': 'guide/en', 'authors': ['MathAdventureTeam']}])
    ...
    def generate_basic(self) -> None:
        ...
        if victory_location.item is None:
            victory_item = MathProof2p2e4WorldGenItem(
                "Victory",
    ...
    def create_item(self, name: str) -> Item:
        ...
        return MathProof2p2e4WorldGenItem(name, data.classification, data.id, self.player)
