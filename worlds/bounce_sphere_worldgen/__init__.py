"""
Bounce Sphere WorldGen world implementation for Archipelago.
...
from .Items import item_table, ItemData, BounceSphereWorldGenItem
from .Locations import location_table, BounceSphereWorldGenLocation
from .Options import BounceSphereWorldGenOptions
...
class BounceSphereWorldGenWeb(WebWorld):
    """Web interface for Bounce Sphere WorldGen."""
    theme = "ocean"
    game_info_languages: List[str] = ['en']
    tutorials = [
        Tutorial(
            "Multiworld Setup Guide",
            "A guide to setting up the Bounce Sphere WorldGen world for Archipelago.",
            "English",
            "setup_en.md",
            "setup/en",
            ["Auto-generated"]
...
class ProcgenMazeWorld(RuleWorldMixin, World):
    """
    Bounce Sphere WorldGen for Archipelago.

    Auto-generated world implementation.
    """

    game: ClassVar[str] = "Bounce Sphere WorldGen"
    web: ClassVar[WebWorld] = BounceSphereWorldGenWeb()

    options_dataclass = BounceSphereWorldGenOptions
    options: BounceSphereWorldGenOptions
    ...
    item_name_groups: ClassVar[Dict[str, frozenset]] = {
        "Everything": frozenset(["Left arrow", "Victory", "Brown platforms", "Right arrow", "Blue platforms", "Springs", "Jetpacks"]),
    }
    ...
    canonical_placements: ClassVar[Dict[str, str]] = {
        "region_3_2__loc_0": "Left arrow",
        "region_4_2__loc_0": "Victory",
        "region_4_2__loc_1": "Brown platforms",
        "region_3_3__loc_0": "Right arrow",
        "region_4_3__loc_0": "Blue platforms",
        "region_4_3__loc_1": "Springs",
        "region_3_4__loc_0": "Jetpacks",
    }
    ...
    def create_item(self, name: str) -> Item:
        ...
        item = BounceSphereWorldGenItem(name, data.classification, data.id, self.player)
        return item
