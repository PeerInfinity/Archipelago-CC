"""
Region definitions for Bounce Sphere WorldGen.
...
def create_regions(multiworld: MultiWorld, player: int) -> None:
    ...
    # Create all regions
    region_names = ["Menu", "region_3_2", "region_4_2", "region_3_3", "region_4_3", "region_3_4"]
    ...
    for location_name, location_data in location_table.items():
        ...
        location = BounceSphereWorldGenLocation(
            player,
            location_name,
    ...
    # Create entrances
    _create_entrance(regions["Menu"], regions["region_3_3"], "GameStart")
    _create_entrance(regions["region_3_2"], regions["region_4_2"], "region_3_2__exit_E")
    _create_entrance(regions["region_3_2"], regions["region_3_3"], "region_3_2__region_3_3")
    _create_entrance(regions["region_4_2"], regions["region_3_2"], "region_3_2")
    _create_entrance(regions["region_3_3"], regions["region_4_3"], "region_3_3__exit_E")
    _create_entrance(regions["region_3_3"], regions["region_3_2"], "exit_N")
    _create_entrance(regions["region_3_3"], regions["region_3_4"], "exit_S")
    _create_entrance(regions["region_4_3"], regions["region_3_3"], "region_4_3__region_3_3")
    _create_entrance(regions["region_3_4"], regions["region_3_3"], "region_3_4__region_3_3")
