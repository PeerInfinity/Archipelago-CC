...
from .Items import item_table, AShortHikeWorldGenItem
...
class AShortHikeWorldGenWorld(RuleWorldMixin, World):
    """
    A Short Hike WorldGen for Archipelago.
    ...
    def __init__(self, multiworld: "MultiWorld", player: int):
        ...
        self.web = types.SimpleNamespace(theme='ocean', tutorials=[{'name': 'Multiworld Setup Guide', 'description': 'A guide to setting up the A Short Hike randomizer connected to an Archipelago Multiworld', 'language': 'English', 'file_name': 'setup_en.md', 'link': 'setup/en', 'authors': ['Chandler']}])
    ...
    def create_item(self, name: str) -> Item:
        ...
        return AShortHikeWorldGenItem(name, data.classification, data.id, self.player)
