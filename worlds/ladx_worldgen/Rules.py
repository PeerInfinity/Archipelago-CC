...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        And(Has("Manbo's Mambo"), Has('Ocarina'))
    )
    ...
    world.set_rule(
        ...
        Or(Has('Bomb'), Has('Boomerang'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Power Bracelet'), Has('Progressive Sword'))
    )
    ...
    world.set_rule(
        ...
        Or(Has('Boomerang'), Has('Feather'), Has('Hookshot'), Has('Rooster'))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Bomb'), Has('Boomerang'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Power Bracelet'), Has('Progressive Sword')), Or(Has('Feather'), Has('Magic Powder'), Has('Rooster')))
    )

    world.set_rule(
        multiworld.get_entrance("Forest -> Graveyard", player),
        Or(Has('Feather'), Has('Progressive Power Bracelet'), Has('Rooster'))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Sword')), Has('RUPEES', 20))
    )
    ...
    world.set_rule(
        ...
        Or(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Rod'), Has('Progressive Sword')), Or(Has('Bomb'), Has('Boomerang'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Power Bracelet'), Has('Progressive Sword')), Has('Progressive Shield'))
    )
    ...
    world.set_rule(
        ...
        Or(And(Has('Feather'), Has('Pegasus Boots')), Has('Rooster'))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Bomb'), Has('Boomerang'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Power Bracelet'), Has('Progressive Sword')), Or(Has('Flippers'), Has('Rooster')))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Boomerang'), Has('Magic Rod'), Has('Progressive Sword')), Or(Has('Feather'), Has('Rooster')))
    )
    ...
    world.set_rule(
        ...
        And(Has('Feather'), Has('Fishing Hook'), Has('Flippers'))
    )

    world.set_rule(
        multiworld.get_entrance("No Name 3 -> Mermaid (Martha's Bay)", player),
        And(Has('Flippers'), Has('Necklace'))
    )
    ...
    world.set_rule(
        ...
        Or(Has('Feather'), Has('Flippers'), Has('Rooster'))
    )

    world.set_rule(
        multiworld.get_entrance("No Name 4 -> Outside D3 Island Bush (Ukuku Prairie)", player),
        And(Or(Has('Bomb'), Has('Boomerang'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Power Bracelet'), Has('Progressive Sword')), Has('Flippers'))
    )
    ...
    world.set_rule(
        ...
        And(Or(And(Has('Feather'), Has('Pegasus Boots')), Has('Rooster')), Or(Has('Hookshot'), Has('Rooster')), Has('Progressive Power Bracelet'))
    )

    world.set_rule(
        multiworld.get_entrance("No Name 4 -> No Name 26", player),
        Or(Has('Bomb'), Has('Boomerang'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Sword'))
    )
    ...
    world.set_rule(
        ...
        And(And(Has('Ballad of the Wind Fish'), Has('Ocarina')), Has('Conch Horn'), Has('Coral Triangle'), Has('Full Moon Cello'), Has('Organ of Evening Calm'), Has("Sea Lily's Bell"), Has('Surf Harp'), Has('Thunder Drum'), Has('Wind Marimba'))
    )

    world.set_rule(
        multiworld.get_entrance("Swamp -> Forest", player),
        Or(And(Or(Has('Bomb'), Has('Boomerang'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Power Bracelet'), Has('Progressive Sword')), Or(Has('Feather'), Has('Magic Powder'), Has('Rooster'))), Or(Has('Bomb'), Has('Boomerang'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Power Bracelet'), Has('Progressive Sword')))
    )

    world.set_rule(
        multiworld.get_entrance("Swamp -> Toadstool (Mysterious Woods)", player),
        Or(Has('Feather'), Has('Rooster'))
    )

    world.set_rule(
        multiworld.get_entrance("Swamp -> Swamp Chest", player),
        Or(Has('Boomerang'), Has('BowWow'), Has('Hookshot'), Has('Magic Rod'))
    )
    ...
    world.set_rule(
        ...
        Or(Has('Feather'), Has('Hookshot'), Has('Rooster'))
    )
    ...
    world.set_rule(
        ...
        Or(Has('Magic Powder'), Has('Magic Rod'))
    )
    ...
    world.set_rule(
        ...
        Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Progressive Sword'))
    )

    world.set_rule(
        multiworld.get_entrance("D2 Room 2 -> First Switch Locked Chest (Bottle Grotto)", player),
        Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Rod'), Has('Progressive Sword'))
    )

    world.set_rule(
        multiworld.get_entrance("D2 Room 2 -> Mask-Mimic Chest (Bottle Grotto)", player),
        And(Or(Or(Has('Bomb'), Has('Progressive Sword')), Or(Has('Bow'), Has('Magic Rod'))), Has('Small Key (Bottle Grotto)', 5), Has('Small Key (Bottle Grotto)'))
    )
    ...
    world.set_rule(
        ...
        Or(And(Or(Has('Bow'), Has('Magic Rod')), Has('Feather')), Or(Has('Bomb'), Has('Progressive Sword')))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Rod'), Has('Progressive Sword')), Has('Feather'))
    )
    ...
    world.set_rule(
        ...
        And(Or(And(Has('Ballad of the Wind Fish'), Has('Ocarina')), Has('Bomb'), Has('Bow'), Has('Magic Rod'), Has('Progressive Power Bracelet')), Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Sword')))
    )

    world.set_rule(
        multiworld.get_entrance("Second Switch Locked Chest (Bottle Grotto) -> D2 Room 5", player),
        And(Has('Progressive Power Bracelet'), Has('Small Key (Bottle Grotto)', 5), Has('Small Key (Bottle Grotto)'))
    )
    ...
    world.set_rule(
        ...
        And(And(Or(Has('Magic Rod'), Has('Progressive Sword')), Has('Progressive Power Bracelet')), Has('Nightmare Key (Bottle Grotto)'))
    )
    ...
    world.set_rule(
        ...
        Or(Or(Has('Magic Powder'), Has('Magic Rod')), Has('Bow'))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Sword')), Or(Has('Feather'), Has('Hookshot')))
    )
    ...
    world.set_rule(
        ...
        Or(Has('Bow'), Has('Magic Rod'), Has('Progressive Sword'))
    )

    world.set_rule(
        multiworld.get_entrance("No Name 9 -> Crow Rock Leaf (Kanalet Castle)", player),
        And(Or(Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Rod'), Has('Progressive Sword')), Has('Progressive Power Bracelet'))
    )
    ...
    world.set_rule(
        ...
        Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Sword'))
    )

    world.set_rule(
        multiworld.get_entrance("No Name 11 -> Bombable Darknut Leaf (Kanalet Castle)", player),
        And(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Sword')), Has('Bomb'))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Rod'), Has('Progressive Sword')), Has('Progressive Power Bracelet'))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Sword')), Has('Progressive Shield'))
    )

    world.set_rule(
        multiworld.get_entrance("D4 Room -> D4 Room 10", player),
        And(Has('Feather'), Has('Pegasus Boots'))
    )

    world.set_rule(
        multiworld.get_entrance("D4 Room -> No Name 15", player),
        Or(Has('Angler Key'), Has('Flippers'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Progressive Shield'), Has('Progressive Sword'))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Feather'), Has('Flippers')), Has("Small Key (Angler's Tunnel)", 2), Has("Small Key (Angler's Tunnel)"))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Feather'), Has('Flippers')), Has("Small Key (Angler's Tunnel)", 4), Has("Small Key (Angler's Tunnel)"))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Sword')), Has('Flippers'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Progressive Sword'), Has("Small Key (Angler's Tunnel)", 5), Has("Small Key (Angler's Tunnel)"))
    )

    world.set_rule(
        multiworld.get_entrance("D4 Room 5 -> D4 Room 8", player),
        And(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Rod'), Has('Progressive Sword')), Has('Flippers'), Has("Small Key (Angler's Tunnel)", 5), Has("Small Key (Angler's Tunnel)"))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Flippers'), Has('Pegasus Boots')), Has('Feather'))
    )
    ...
    world.set_rule(
        ...
        And(And(Or(Has('Bow'), Has('Magic Rod'), Has('Progressive Sword')), Has('Flippers')), Has("Nightmare Key (Angler's Tunnel)"))
    )
    ...
    world.set_rule(
        ...
        Or(Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Rod'), Has('Progressive Sword'))
    )
    ...
    world.set_rule(
        ...
        Or(And(Has('Bomb'), Has('Feather'), Has('Hookshot')), Has('Rooster'))
    )
    ...
    world.set_rule(
        ...
        Or(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Rod'), Has('Progressive Sword')), Has('Progressive Shield'))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Sword')), Has('RUPEES', 100))
    )
    ...
    world.set_rule(
        ...
        Or(Has('Feather'), Has('Progressive Sword'))
    )
    ...
    world.set_rule(
        ...
        Or(Has('Pegasus Boots'), Has('Rooster'))
    )
    ...
    world.set_rule(
        ...
        And(Has('ANGLER_KEYHOLE'), Has('Angler Key'))
    )

    world.set_rule(
        multiworld.get_entrance("No Name 35 -> No Name 36", player),
        Or(Has('Flippers'), Has('Rooster'))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Feather'), Has('Rooster')), Has('Progressive Power Bracelet'))
    )
    ...
    world.set_rule(
        ...
        And(Has("Frog's Song of Soul"), Has('Ocarina'), Has('Progressive Sword'))
    )
    ...
    world.set_rule(
        ...
        Or(And(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Rod'), Has('Progressive Sword')), Has('Progressive Power Bracelet')), Has('Feather'))
    )

    world.set_rule(
        multiworld.get_entrance("D8 Room -> Zamboni, Two Zol Key (Turtle Rock)", player),
        And(Or(And(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Sword')), Has('Progressive Power Bracelet')), Has('Bomb')), Has('Feather'))
    )
    ...
    world.set_rule(
        ...
        Or(Or(And(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Rod'), Has('Progressive Sword')), Has('Feather')), Has('Boomerang'), Has('Bow'), Has('Magic Rod')), Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Rod'), Has('Progressive Sword')))
    )
    ...
    world.set_rule(
        ...
        Or(And(Has('Hookshot'), Has('Magic Rod')), Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Progressive Sword'))
    )

    world.set_rule(
        multiworld.get_entrance("D8 Room 3 -> Lava Ledge Chest (Turtle Rock)", player),
        And(Has('Feather'), Has('Hookshot'))
    )
    ...
    world.set_rule(
        ...
        And(And(Has('Small Key (Turtle Rock)', 4), Has('Small Key (Turtle Rock)')), Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Sword')))
    )
    ...
    world.set_rule(
        ...
        And(Has('Hookshot'), Has('Small Key (Turtle Rock)', 7), Has('Small Key (Turtle Rock)'))
    )

    world.set_rule(
        multiworld.get_entrance("D8 Room 7 -> Magic Rod Chest (Turtle Rock)", player),
        And(Has('Feather'), Has('Progressive Sword'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Feather'), Has('Progressive Sword'), Has('Small Key (Turtle Rock)', 7), Has('Small Key (Turtle Rock)'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Magic Rod'), Has('Nightmare Key (Turtle Rock)'))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Feather'), Has('Rooster')), Has('Hookshot'))
    )

    world.set_rule(
        multiworld.get_entrance("No Name 57 -> No Name 58", player),
        And(Has('Bird Key'), Has('Progressive Power Bracelet'))
    )
    ...
    world.set_rule(
        ...
        Or(And(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Rod'), Has('Progressive Sword')), Or(Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Rod'), Has('Progressive Sword'))), And(Or(Has('Bomb'), Has('Feather')), Has('Progressive Shield')))
    )
    ...
    world.set_rule(
        ...
        Or(And(Has("Small Key (Eagle's Tower)", 3), Has("Small Key (Eagle's Tower)")), Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Rod'), Has('Progressive Sword')))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Hookshot'), Has('Magic Rod'), Has('Progressive Sword')), Has('Progressive Shield', 2))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Boomerang'), Has('Bow')), Has('Magic Powder'), Has('Progressive Sword'))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Sword')), Has('Progressive Sword'))
    )
    ...
    world.set_rule(
        ...
        Or(And(Or(Has('Hookshot'), Has('Pegasus Boots')), Has('Bomb'), Has('Feather')), Has('Rooster'))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Bomb'), Has('Boomerang'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Power Bracelet'), Has('Progressive Sword')), Has('Shovel'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Magic Powder'), Has('Small Key (Color Dungeon)', 3), Has('Small Key (Color Dungeon)'))
    )

    world.set_rule(
        multiworld.get_entrance("Lower Small Key (Color Dungeon) -> D9 Room 3", player),
        And(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Rod'), Has('Progressive Sword')), Has('Small Key (Color Dungeon)', 2), Has('Small Key (Color Dungeon)'))
    )
    ...
    world.set_rule(
        ...
        Or(And(Has('Feather'), Has('Pegasus Boots')), Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Rod'), Has('Progressive Sword')))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Rod'), Has('Progressive Sword')), Has('Nightmare Key (Color Dungeon)'))
    )
    ...
    world.set_rule(
        ...
        Or(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Sword')), Has('Pegasus Boots'))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Progressive Sword')), Has('Pegasus Boots'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Bomb'), Has('Feather'), Has('Pegasus Boots'))
    )
    ...
    world.set_rule(
        ...
        Or(And(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Sword')), Has('Progressive Shield')), Has('Bomb'), Has('Progressive Sword'))
    )

    world.set_rule(
        multiworld.get_entrance("D3 Room 6 -> Two Zol, Two Pairodd Key (Key Cavern)", player),
        Or(Has('Bomb'), Has('Bow'), Has('Hookshot'), Has('Magic Rod'), Has('Progressive Sword'))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Bomb'), Has('Bow'), Has('Hookshot'), Has('Magic Rod'), Has('Progressive Sword')), Has('Feather'), Has('Pegasus Boots'))
    )
    ...
    world.set_rule(
        ...
        And(And(Has('Pegasus Boots'), Has('Progressive Sword')), Has('Nightmare Key (Key Cavern)'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Bomb'), Has('Pegasus Boots'))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Sword')), Has('Ocarina'), Has('RUPEES', 1480))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Feather'), Has('Rooster')), Has('Bomb'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Bomb'), Has('Progressive Sword'))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Rod')), Has('Hookshot'), Has("Small Key (Catfish's Maw)", 2), Has("Small Key (Catfish's Maw)"))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Sword')), Has('Feather'))
    )
    ...
    world.set_rule(
        ...
        And(And(Has('Hookshot'), Has('Progressive Sword')), Has("Nightmare Key (Catfish's Maw)"))
    )
    ...
    world.set_rule(
        ...
        Or(And(Has('Feather'), Has('Pegasus Boots')), Has('Hookshot'))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Progressive Sword')), Has('Progressive Power Bracelet'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Bomb'), Has('Feather'), Has('Progressive Sword'))
    )
    ...
    world.set_rule(
        ...
        Or(And(Or(And(Has('Feather'), Has('Pegasus Boots')), Has('Flippers')), Has('Hookshot')), Has('Rooster'))
    )
    ...
    world.set_rule(
        ...
        Or(Or(Has('Bomb'), Has('Magic Rod')), Has('Progressive Power Bracelet', 2))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Bomb'), Has('Magic Rod')), Has('Progressive Power Bracelet'))
    )

    world.set_rule(
        multiworld.get_entrance("D6 Room -> D6 Room 2", player),
        And(Or(Has('Bomb'), Has('Boomerang')), Has('Progressive Power Bracelet'))
    )

    world.set_rule(
        multiworld.get_entrance("D6 Room -> Water Tektite Chest (Face Shrine)", player),
        And(Or(Has('Bomb'), Has('Magic Rod')), Has('Progressive Power Bracelet', 2))
    )
    ...
    world.set_rule(
        ...
        Or(Or(Has('Bomb'), Has('Magic Rod')), Has('Bow'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Bomb'), Has('Progressive Power Bracelet'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Feather'), Has('Progressive Power Bracelet', 2))
    )
    ...
    world.set_rule(
        ...
        And(Has('Bomb'), Has('Nightmare Key (Face Shrine)'))
    )

    world.set_rule(
        multiworld.get_entrance("Tile Room Key (Face Shrine) -> Top Right Horse Heads Chest (Face Shrine)", player),
        And(Or(And(Has('Ballad of the Wind Fish'), Has('Ocarina')), Has('Bomb'), Has('Magic Rod')), Has('Pegasus Boots'), Has('Progressive Power Bracelet', 2), Has('Small Key (Face Shrine)', 2), Has('Small Key (Face Shrine)'))
    )
    ...
    world.set_rule(
        ...
        Or(And(Has('Hookshot'), Has('Progressive Power Bracelet'), Has('Small Key (Face Shrine)', 3), Has('Small Key (Face Shrine)')), And(Has('Hookshot'), Has('Small Key (Face Shrine)', 3), Has('Small Key (Face Shrine)')))
    )

    world.set_rule(
        multiworld.get_entrance("Pot Locked Chest (Face Shrine) -> Top Right Horse Heads Chest (Face Shrine)", player),
        And(Has('Hookshot'), Has('Small Key (Face Shrine)', 3), Has('Small Key (Face Shrine)'))
    )
    ...
    world.set_rule(
        ...
        Or(And(Or(Has('Bomb'), Has('Boomerang'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Power Bracelet'), Has('Progressive Sword')), Or(Has('Feather'), Has('Rooster'))), And(Or(Has('Boomerang'), Has('Magic Rod'), Has('Progressive Sword')), Or(Has('Feather'), Has('Rooster'))))
    )
    ...
    world.set_rule(
        ...
        Or(Or(Has('Boomerang'), Has('Feather'), Has('Hookshot')), Has('Progressive Sword'))
    )
    ...
    world.set_rule(
        ...
        And(Has("Frog's Song of Soul"), Has('Ocarina'))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Sword')), Has('RUPEES', 500))
    )

    world.set_rule(
        multiworld.get_entrance("Shop -> Shop 980 Item (Mabe Village)", player),
        And(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Sword')), Has('RUPEES', 1480))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Sword')), Has('RUPEES', 50))
    )
    ...
    world.set_rule(
        ...
        Or(Or(Has('Boomerang'), Has('Hookshot'), Has('Progressive Shield'), Has('Progressive Sword')), Has('Bomb'))
    )

    world.set_rule(
        multiworld.get_entrance("D1 Room -> Mini-Moldorm Spawn Chest (Tail Cave)", player),
        Or(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Sword')), Has('Progressive Shield'))
    )

    world.set_rule(
        multiworld.get_entrance("D1 Room -> Two Stalfos, Two Keese Chest (Tail Cave)", player),
        And(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Powder'), Has('Magic Rod'), Has('Progressive Sword')), Or(Or(Has('Bomb'), Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Progressive Sword')), Has('Progressive Shield')))
    )
    ...
    world.set_rule(
        ...
        And(Has('Feather'), Has('Small Key (Tail Cave)', 3), Has('Small Key (Tail Cave)'))
    )
    ...
    world.set_rule(
        ...
        Or(Or(Has('Boomerang'), Has('Bow'), Has('Hookshot'), Has('Magic Rod'), Has('Progressive Sword')), Has('Progressive Shield'))
    )
