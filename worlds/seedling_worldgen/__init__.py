"""
Seedling WorldGen world implementation for Archipelago.
...
from .Items import item_table, ItemData, SeedlingWorldGenItem
from .Locations import location_table, SeedlingWorldGenLocation
from .Options import SeedlingWorldGenOptions
...
class SeedlingWorldGenWeb(WebWorld):
    """Web interface for Seedling WorldGen."""
    theme = "grass"
...
class SeedlingWorld(RuleWorldMixin, World):
    """
    Seedling WorldGen for Archipelago.

    Auto-generated world implementation.
    """

    game: ClassVar[str] = "Seedling WorldGen"
    web: ClassVar[WebWorld] = SeedlingWorldGenWeb()

    options_dataclass = SeedlingWorldGenOptions
    options: SeedlingWorldGenOptions
    ...
    item_name_groups: ClassVar[Dict[str, frozenset]] = {
        "Everything": frozenset(["Progressive Sword", "Progressive Shield", "Red Key", "Light", "Green Key", "Fire", "Progressive Swim", "Blue Key", "Totem Shard", "Purple Key", "Wand", "Ghost Spear", "Yellow Key", "Health", "Dark Suit", "Ghost Sword Fusion", "Fire Wand Fusion", "Seal", "Nothing"]),
    }
    ...
    canonical_placements: ClassVar[Dict[str, str]] = {
        "Penguin's Feather": "Yellow Key",
        "Chest (Gundernourd Pit)": "Seal",
        "Chest (Rostef)": "Seal",
        "Chest (South Rocks)": "Seal",
        "Chest (Trohn Inside)": "Seal",
        "Conch": "Seal",
        "Dark Shield": "Seal",
        "Dark Sword": "Seal",
        "Fire Wand": "Seal",
        ...
        "Red Key": "Seal",
        "Shield": "Seal",
        "Totem Shard (One Moving Block Puzzle)": "Seal",
        "Totem Shard (Three Blocks Puzzle)": "Seal",
        "Wand": "Seal",
        "Chest (Spawn House)": "Purple Key",
        "Chest (Waterfall)": "Blue Key",
        "Chest (Adnan's cave)": "Progressive Swim",
        "Chest (Gundernourd Water)": "Progressive Swim",
        "Sword": "Ghost Spear",
        "Chest (Owl's Nest)": "Dark Suit",
        "Blue Key": "Totem Shard",
        "Dark Suit": "Totem Shard",
        "Green Key": "Totem Shard",
        "Totem Shard (Main Room Left)": "Totem Shard",
        "Yellow Key": "Totem Shard",
        "Fire": "Fire Wand Fusion",
        "Chest (Bosiniad Lava)": "Progressive Sword",
        "Chest (Trohn Outside)": "Progressive Sword",
        "Totem Shard (Mortar)": "Ghost Sword Fusion",
        "Chest (Bosiniad Main Room)": "Progressive Shield",
        "Totem Shard (Two Moving Blocks Puzzle)": "Progressive Shield",
        "Purple Key": "Green Key",
        "Chest (Lacste Entrance)": "Fire",
        "Chest (Lacste Main Room)": "Red Key",
        "Health": "Health",
        "Chest (Woshad)": "Wand",
        "Chest (Ghethis)": "Light",
    }
    ...
    canonical_placement_advancements: ClassVar[Dict[str, bool]] = {
        "Penguin's Feather": True,
        "Dark Sword": True,
        "Chest (Spawn House)": True,
        "Chest (Waterfall)": True,
        "Chest (Adnan's cave)": True,
        "Chest (South Rocks)": True,
        "Sword": True,
        "Chest (Owl's Nest)": True,
        "Shield": True,
        "Red Key": True,
        "Chest (Gundernourd Water)": True,
        "Chest (Gundernourd Pit)": True,
        "Light": True,
        "Green Key": True,
        "Fire": True,
        "Chest (Rostef)": True,
        "Conch": True,
        "Blue Key": True,
        "Chest (Trohn Inside)": True,
        "Chest (Trohn Outside)": True,
        "Totem Shard (Three Blocks Puzzle)": True,
        "Totem Shard (Main Room Left)": True,
        "Totem Shard (Mortar)": True,
        "Totem Shard (One Moving Block Puzzle)": True,
        "Totem Shard (Two Moving Blocks Puzzle)": True,
        "Purple Key": True,
        "Wand": True,
        "Chest (Lacste Entrance)": True,
        "Chest (Lacste Main Room)": True,
        "Ghost Spear": True,
        "Yellow Key": True,
        "Health": True,
        "Chest (Woshad)": True,
        "Dark Shield": True,
        "Dark Suit": True,
        "Chest (Bosiniad Main Room)": True,
        "Chest (Bosiniad Lava)": True,
        "Ghost Sword": True,
        "Fire Wand": True,
        "Chest (Ghethis)": False,
    }
    ...
    def __init__(self, multiworld: "MultiWorld", player: int):
        ...
        self.world_class_name = 'SeedlingWorld'
        self.slot_data = types.SimpleNamespace(ending=0, boss_locations=0, deathlink=0, deathlink_amnesty=15)
    ...
    def create_item(self, name: str) -> Item:
        ...
        item = SeedlingWorldGenItem(name, data.classification, data.id, self.player)
        return item
