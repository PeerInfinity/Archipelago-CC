"""
Seedling Playthrough world implementation for Archipelago.
...
from .Items import item_table, ItemData, SeedlingPlaythroughItem
from .Locations import location_table, SeedlingPlaythroughLocation
from .Options import SeedlingPlaythroughOptions
...
class SeedlingPlaythroughWeb(WebWorld):
    """Web interface for Seedling Playthrough."""
    theme = "ocean"
    game_info_languages: List[str] = ['en']
    tutorials = [
        Tutorial(
            "Multiworld Setup Guide",
            "A guide to setting up the Seedling Playthrough world for Archipelago.",
            "English",
            "setup_en.md",
            "setup/en",
            ["Auto-generated"]
...
class SeedlingPlaythroughWorld(RuleWorldMixin, World):
    """
    Seedling Playthrough for Archipelago.

    Auto-generated world implementation.
    """

    game: ClassVar[str] = "Seedling Playthrough"
    web: ClassVar[WebWorld] = SeedlingPlaythroughWeb()

    options_dataclass = SeedlingPlaythroughOptions
    options: SeedlingPlaythroughOptions
    ...
    canonical_placements: ClassVar[Dict[str, str]] = {
        ...
        "Level 012 - Chest": "Seal",
        "Level 015 - Chest": "Seal",
        "Level 017 - Chest": "Seal",
        "Level 025 - Chest": "Seal",
        "Level 036 - Chest": "Seal",
        "Level 038 - Chest": "Seal",
        "Level 040 - Chest": "Seal",
        "Level 046 - Chest": "Seal",
        "Level 048 - Chest": "Seal",
        "Level 063 - Chest": "Seal",
        "Level 071 - Chest": "Seal",
        "Level 080 - Chest": "Seal",
        ...
        "Level 039 - Totem Part 72,40": "Totem Shard",
        "Level 040 - Totem Part 160,640": "Totem Shard",
        "Level 040 - Totem Part 64,144": "Totem Shard",
        "Level 041 - Totem Part 240,144": "Totem Shard",
        "Level 042 - Totem Part 184,152": "Totem Shard",
        "Level 040 - Boss Key 2": "Purple Key",
        "Level 043 - Wand": "Wand",
        "Level 049 - Conch": "Progressive Swim",
        "Level 089 - Feather": "Progressive Swim",
        "Level 055 - Boss Key 3": "Blue Key",
    ...
    canonical_placement_advancements: ClassVar[Dict[str, bool]] = {
        ...
        "Level 032 - Bob Boss": True,
        "Level 036 - Chest": True,
        "Level 038 - Chest": True,
        "Level 039 - Totem Part 72,40": True,
        "Level 040 - Totem Part 64,144": True,
        "Level 040 - Totem Part 160,640": True,
        "Level 040 - Chest": True,
        "Level 040 - Boss Key 2": True,
        "Level 041 - Totem Part 240,144": True,
        "Level 042 - Totem Part 184,152": True,
        "Level 043 - Wand": True,
        "Level 046 - Chest": True,
        "Level 048 - Chest": True,
        "Level 049 - Conch": True,
        "Level 055 - Boss Key 3": True,
        "Level 063 - Chest": True,
        "Level 064 - Ghostspear": True,
        ...
        "Level 086 - Chest": True,
        "Level 089 - Feather": True,
        "Level 090 - Chest": True,
    ...
    def __init__(self, multiworld: "MultiWorld", player: int):
        ...
        self.world_class_name = 'SeedlingPlaythroughWorld'
    ...
    def generate_basic(self) -> None:
        ...
        self.multiworld.completion_condition[self.player] = \
            lambda state: state.has("The Seed", self.player)
    ...
    def create_item(self, name: str) -> Item:
        ...
        item = SeedlingPlaythroughItem(name, data.classification, data.id, self.player)
        return item
