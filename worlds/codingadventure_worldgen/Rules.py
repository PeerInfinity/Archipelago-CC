...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        And(Or(Has('Git'), Has('JavaScript Basics'), Has('Server Basics')), Has('CSS'), Has('HTML'))
    )

    world.set_rule(
        multiworld.get_entrance("ToInteractiveApp", player),
        Or(And(Has('Database Basics'), Has('State Management')), And(Has('Frontend Framework'), Has('REST APIs')))
    )
    ...
    world.set_rule(
        ...
        And(Or(And(Has('DevOps'), Has('Performance')), And(Has('DevOps'), Has('Testing')), And(Has('Performance'), Has('Testing'))), Has('Authentication'))
    )

    world.set_rule(
        multiworld.get_entrance("ToProduction", player),
        And(Has('Deployment Complete'), Has('Scaling Complete'), Has('Security Complete'))
    )
    # Location rules
    world.set_rule(
    ...
    world.set_rule(
        ...
        Or(Has('Database Basics'), Has('REST APIs'))
    )
