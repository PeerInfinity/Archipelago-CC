...
class AHatinTimeWorldGenWorld(RuleWorldMixin, World):
    ...
    def generate_early(self) -> None:
        """Push starting items as precollected and set up world attributes."""
        self._push_starting_items()
        # Set up hat attributes needed by can_use_hat helper
        # These use integer keys matching the helper's hat parameter (0-4)
        # Values are the yarn cost - use a typical cost of 6 per hat
        self.hat_yarn_costs = {0: 6, 1: 6, 2: 6, 3: 6, 4: 6}
        self.hat_craft_order = [0, 1, 2, 3, 4]
