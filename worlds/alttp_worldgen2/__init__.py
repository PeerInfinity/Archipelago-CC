...
class ALTTPWorld(RuleWorldMixin, World):
    ...
    def create_item(self, name: str) -> Item:
        ...
        if classification_counts:
            ...
            item = ALinktothePastWorldGen2Item(name, classification, data.id, self.player)
        else:
