...
class ALTTPWorld(RuleWorldMixin, World):
    ...
    item_name_groups: ClassVar[Dict[str, frozenset]] = {
        ...
        "Event": frozenset(["Beat Agahnim 1", "Beat Agahnim 2", "Return Smith", "Crystal 4", "Capacity Upgrade Shop", "Open Floodgate", "Red Pendant", "Crystal 2", "Pick Up Purple Chest", "Crystal 1", "Crystal 6", "Blue Pendant", "Green Pendant", "Crystal 5", "Crystal 7", "Crystal 3", "Get Frog"]),
        "Crystals": frozenset(["Crystal 4", "Crystal 2", "Crystal 1", "Crystal 6", "Crystal 5", "Crystal 7", "Crystal 3"]),
