...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        And(HelperCall(helper_func=has_sword, helper_name="has_sword"), Has('Small Key (Agahnims Tower)', 4), Has('Lamp'))
    )
    ...
    world.set_rule(
        ...
        And(HelperCall(helper_func=has_sword, helper_name="has_sword"), Has('Small Key (Skull Woods)', 4), Has('Fire Rod'))
    )
