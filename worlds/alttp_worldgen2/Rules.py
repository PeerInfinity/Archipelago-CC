"""
Access rules for A Link to the Past WorldGen2.
...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        HasAllCounts({'Small Key (Hyrule Castle)': 4, 'Lamp': 1})
    )
    ...
    world.set_rule(
        ...
        HasAllCounts({'Small Key (Swamp Palace)': 5, 'Hookshot': 1})
    )
    ...
    world.set_rule(
        ...
        And(HelperCall(helper_func=can_shoot_arrows, helper_name="can_shoot_arrows"), HasAllCounts({'Small Key (Palace of Darkness)': 6, 'Big Key (Palace of Darkness)': 1, 'Hammer': 1, 'Lamp': 1}))
    )
    ...
    world.set_rule(
        ...
        HasAllCounts({'Small Key (Palace of Darkness)': 6, 'Lamp': 1})
    )
    ...
    world.set_rule(
        ...
        HasAllCounts({'Small Key (Ganons Tower)': 6, 'Hookshot': 1})
    )
    ...
    world.set_rule(
        ...
        And(HelperCall(helper_func=can_kill_most_things, helper_name="can_kill_most_things", args=(4,)), Has('Small Key (Desert Palace)', 2))
    )

    world.set_rule(
        multiworld.get_location("Desert Palace - Desert Tiles 2 Pot Key", player),
        And(HelperCall(helper_func=can_kill_most_things, helper_name="can_kill_most_things", args=(4,)), Has('Small Key (Desert Palace)', 3))
    )

    multiworld.get_location("Desert Palace - Boss", player).access_rule = \
        lambda state: ((state.multiworld.get_location('Desert Palace - Boss', player).parent_region.dungeon.boss.can_defeat(state)) and (has_fire_source(state, player)) and (state.has('Small Key (Desert Palace)', player, 4)) and (state.has('Big Key (Desert Palace)', player)))
    ...
    multiworld.get_location("Hyrule Castle - Zelda's Chest", player).access_rule = \
        lambda state: (((((state.multiworld.worlds[player].options.enemy_health in (0, 1))) or (can_kill_most_things(state, player, 1)))) and (state.has('Small Key (Hyrule Castle)', player, 4)) and (state.has('Big Key (Hyrule Castle)', player)))
    ...
    world.set_rule(
        ...
        And(HelperCall(helper_func=can_kill_most_things, helper_name="can_kill_most_things", args=(1,)), Has('Small Key (Hyrule Castle)', 4))
    )
    ...
    world.set_rule(
        ...
        And(HelperCall(helper_func=can_use_bombs, helper_name="can_use_bombs"), HasAllCounts({'Small Key (Ganons Tower)': 7, 'Moon Pearl': 1}))
    )
