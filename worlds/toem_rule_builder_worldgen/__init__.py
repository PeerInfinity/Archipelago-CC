...
class TOEMrulebuilderWorldGenWorld(RuleWorldMixin, World):
    ...
    def __init__(self, multiworld: "MultiWorld", player: int):
        ...
        self.web = types.SimpleNamespace(theme='grassFlowers', tutorials=[{'name': 'Setup Guide', 'description': 'A guide to setting up the TOEM randomizer.', 'language': 'English', 'file_name': 'setup_en.md', 'link': 'setup/en', 'authors': ['DrTChops']}])
