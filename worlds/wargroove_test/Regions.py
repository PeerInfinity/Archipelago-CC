"""
Region definitions for Wargroove Test.
...
def create_regions(multiworld: MultiWorld, player: int) -> None:
    ...
    # Create all regions
    region_names = ["A Ballista's Revenge", "A Knight's Folly", "Ambushed in the Middle", "Archery Lessons", "Best Friendssss", "Corrupted Inlet", "Darkest Knight", "Deep Thicket", "Denrunaway", "Doggo Mountain", "Dragon Freeway", "Endless Knight", "Foolish Canal", "Frigid Archery", "Humble Beginnings", "Mage Mayhem", "Master of the Lake", "Menu", "Open Season", "Rebel Village", "Robbed", "Surrounded", "Tenri's Fall", "The Churning Sea", "Wargroove Finale"]
    ...
    for location_name, location_data in location_table.items():
        ...
        location = WargrooveTestLocation(
            player,
            location_name,
