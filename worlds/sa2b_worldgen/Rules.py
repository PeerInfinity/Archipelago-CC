...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        CanReachRegion("Cannon's Core - 1")
    )
    ...
    world.set_rule(
        ...
        (CanReachRegion("Metal Harbor - 1")) & (Has("Sonic - Light Shoes"))
    )
    ...
    world.set_rule(
        ...
        (CanReachRegion("Crazy Gadget - 1")) & (Has("Sonic - Bounce Bracelet"))
    )
    ...
    world.set_rule(
        ...
        (CanReachRegion("Mission Street - 1")) & (Has("Tails - Booster"))
    )
    ...
    world.set_rule(
        ...
        (CanReachRegion("Hidden Base - 1")) & (Has("Tails - Booster"))
    )
    ...
    world.set_rule(
        ...
        (CanReachRegion("Eternal Engine - 1")) & (Has("Tails - Booster"))
    )
    ...
    world.set_rule(
        ...
        ((Has("Knuckles - Hammer Gloves")) & (Has("Knuckles - Shovel Claws"))) & (CanReachRegion("Death Chamber - 1"))
    )
    ...
    world.set_rule(
        ...
        CanReachRegion("Radical Highway - 1")
    )
    ...
    world.set_rule(
        ...
        (CanReachRegion("Lost Colony - 1")) & (Has("Eggman - Jet Engine"))
    )
    ...
    world.set_rule(
        ...
        ((Has("Eggman - Jet Engine")) & (Has("Eggman - Large Cannon"))) & (CanReachRegion("Weapons Bed - 1"))
    )
    ...
    world.set_rule(
        ...
        (CanReachRegion("Cosmic Wall - 1")) & (Has("Eggman - Jet Engine"))
    )
    ...
    world.set_rule(
        ...
        (CanReachRegion("Security Hall - 1")) & (Has("Rouge - Pick Nails"))
    )
    ...
    world.set_rule(
        ...
        (CanReachRegion("Mad Space - 1")) & (Has("Rouge - Iron Boots"))
    )
    ...
    world.set_rule(
        ...
        ((Has("Eggman - Jet Engine")) & (Has("Tails - Booster"))) & (CanReachRegion("Cannon's Core - 1"))
    )
