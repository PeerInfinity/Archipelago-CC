"""
Access rules for Sonic Adventure 2 Battle WorldGen WorldGen.
...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        (True_()) & (Has("Sonic - Bounce Bracelet"))
    )
    ...
    world.set_rule(
        ...
        ((Has("Knuckles - Hammer Gloves")) & (Has("Knuckles - Shovel Claws"))) & (True_())
    )
    ...
    world.set_rule(
        ...
        ((Has("Eggman - Jet Engine")) & (Has("Eggman - Large Cannon"))) & (True_())
    )
    ...
    world.set_rule(
        ...
        ((Has("Eggman - Jet Engine")) & (Has("Tails - Booster"))) & (True_())
    )
