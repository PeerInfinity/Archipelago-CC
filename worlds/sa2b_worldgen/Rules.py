...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        And(Has('Sonic - Bounce Bracelet'), Has('Sonic - Flame Ring'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Sonic - Bounce Bracelet'), Has('Sonic - Light Shoes'), Has('Sonic - Mystic Melody'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Sonic - Bounce Bracelet'), Has('Sonic - Flame Ring'), Has('Sonic - Light Shoes'))
    )

    world.set_rule(
        multiworld.get_location("Crazy Gadget - 2", player),
        And(CanReachLocation('Crazy Gadget - 1'), Has('Sonic - Bounce Bracelet'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Tails - Bazooka'), Has('Tails - Booster'))
    )
    ...
    world.set_rule(
        ...
        And(CanReachLocation('Eternal Engine - 1'), Has('Tails - Booster'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Knuckles - Hammer Gloves'), Has('Knuckles - Shovel Claws'))
    )

    world.set_rule(
        multiworld.get_location("Death Chamber - 2", player),
        And(And(Has('Knuckles - Hammer Gloves'), Has('Knuckles - Shovel Claws')), CanReachLocation('Death Chamber - 1'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Eggman - Jet Engine'), Has('Eggman - Large Cannon'))
    )

    world.set_rule(
        multiworld.get_location("Weapons Bed - 2", player),
        And(And(Has('Eggman - Jet Engine'), Has('Eggman - Large Cannon')), CanReachLocation('Weapons Bed - 1'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Rouge - Iron Boots'), Has('Rouge - Mystic Melody'), Has('Rouge - Pick Nails'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Rouge - Iron Boots'), Has('Rouge - Mystic Melody'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Rouge - Iron Boots'), Has('Rouge - Pick Nails'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Eggman - Jet Engine'), Has('Knuckles - Air Necklace'), Has('Knuckles - Hammer Gloves'), Has('Sonic - Bounce Bracelet'), Has('Tails - Booster'))
    )

    world.set_rule(
        multiworld.get_location("Cannon's Core - 2", player),
        And(And(Has('Eggman - Jet Engine'), Has('Tails - Booster')), CanReachLocation("Cannon's Core - 1"))
    )

    world.set_rule(
        multiworld.get_location("Cannon's Core - Chao Key 1", player),
        And(Has('Eggman - Jet Engine'), Has('Eggman - Large Cannon'), Has('Tails - Booster'))
    )

    world.set_rule(
        multiworld.get_location("Cannon's Core - Chao Key 2", player),
        And(Has('Eggman - Jet Engine'), Has('Tails - Booster'))
    )

    world.set_rule(
        multiworld.get_location("Cannon's Core - Chao Key 3", player),
        And(Has('Eggman - Jet Engine'), Has('Knuckles - Air Necklace'), Has('Knuckles - Hammer Gloves'), Has('Sonic - Flame Ring'), Has('Tails - Booster'))
    )

    world.set_rule(
        multiworld.get_location("Cannon's Core - Gold Beetle", player),
        And(Has('Eggman - Jet Engine'), Has('Knuckles - Air Necklace'), Has('Knuckles - Hammer Gloves'), Has('Tails - Booster'))
    )
