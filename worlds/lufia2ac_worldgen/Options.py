"""
Game options for Lufia II Ancient Cave.
...
@dataclass
class LufiaIIAncientCaveOptions(PerGameCommonOptions):
    """Options for Lufia II Ancient Cave."""
