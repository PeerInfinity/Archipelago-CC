"""
Location definitions for Math Adventure Vanilla WorldGen.
...
class MathAdventureVanillaWorldGenLocation(Location):
    """Location class for Math Adventure Vanilla WorldGen."""
