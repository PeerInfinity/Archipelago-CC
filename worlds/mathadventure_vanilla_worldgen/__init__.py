"""
Math Adventure Vanilla WorldGen world implementation for Archipelago.
...
from .Items import item_table, ItemData, MathAdventureVanillaWorldGenItem
from .Locations import location_table, MathAdventureVanillaWorldGenLocation
from .Options import MathAdventureVanillaWorldGenOptions
...
class MathAdventureVanillaWorldGenWeb(WebWorld):
    """Web interface for Math Adventure Vanilla WorldGen."""
    theme = "ocean"
...
class MathAdventureWorld(RuleWorldMixin, World):
    ...
    game: ClassVar[str] = "Math Adventure Vanilla WorldGen"
    web: ClassVar[WebWorld] = MathAdventureVanillaWorldGenWeb()

    options_dataclass = MathAdventureVanillaWorldGenOptions
    options: MathAdventureVanillaWorldGenOptions
            ...
            if classification_counts:
                ...
                for classification_name, class_count in classification_counts.items():
                    ...
                    for _ in range(class_count):
                        item = MathAdventureVanillaWorldGenItem(
                            item_name,
                            classification,
                            item_data.id,
                            self.player
    ...
    def generate_basic(self) -> None:
        ...
        if victory_location.item is None:
            victory_item = MathAdventureVanillaWorldGenItem(
                "Victory",
    ...
    def create_item(self, name: str) -> Item:
        ...
        item = MathAdventureVanillaWorldGenItem(name, data.classification, data.id, self.player)
        if data.hint_text:
