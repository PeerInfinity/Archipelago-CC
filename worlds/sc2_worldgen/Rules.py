...
def _starcraft2worldgen_terran_competent_anti_air(state: "CollectionState", player: int) -> bool:
    return ((state.has('Goliath', player)) or (((state.has('Marine', player)) or (state.has('Dominion Trooper', player))) and (_starcraft2worldgen_terran_bio_heal(state, player)) and ((state.count('Progressive Terran Infantry Weapon', player) >= 2))) or ((True) and (state.has('Cyclone', player))) or ((True) and (state.has('Thor', player)) and (state.has('Progressive High Impact Payload (Thor)', player)))) or (_starcraft2worldgen_terran_air_anti_air(state, player))
...
def _starcraft2worldgen_terran_maw_requirement(state: "CollectionState", player: int) -> bool:
    return ((state.has('Battlecruiser', player)) and (((state.count('Progressive Terran Ship Weapon', player) >= 2)) or (state.has('ATX Laser Battery (Battlecruiser)', player)))) or ((_starcraft2worldgen_terran_air(state, player)) and (((state.has('Banshee', player)) or (state.has('Battlecruiser', player)) or (state.has('Goliath', player)) or (state.has('Thor', player)) or (state.has('Viking', player)) or (state.has('Warhound', player)) or (state.has('Wraith', player))) or ((state.has('Liberator', player)) and (state.has('Raid Artillery (Liberator)', player))) or ((state.has('Flechette Missiles (Valkyrie)', player)) and (state.has('Valkyrie', player))) or ((state.has('Marauder', player)) and (_starcraft2worldgen_terran_bio_heal(state, player)))) and (((state.has('Cyclone', player)) or (state.has('Goliath', player)) or (state.has('Viking', player))) or (((state.has('Battlecruiser', player)) or (state.has('Valkyrie', player)) or (state.has('Wraith', player))) and ((state.count('Progressive Terran Ship Weapon', player) >= 2))) or ((state.has('Progressive High Impact Payload (Thor)', player)) and (state.has('Thor', player)))) and ((_starcraft2worldgen_terran_competent_anti_air(state, player)) and ((((state.has('Marine', player)) or (state.has('Dominion Trooper', player)) or (state.has('Marauder', player))) and ((state.count('Progressive Terran Infantry Weapon', player) >= 2)) and ((state.count('Progressive Terran Infantry Armor', player) >= 1)) and (_starcraft2worldgen_terran_bio_heal(state, player))) or (((state.has('Banshee', player)) or (state.has('Battlecruiser', player)) or ((state.has('Liberator', player)) and (state.has('Raid Artillery (Liberator)', player))) or ((state.has('Wraith', player)) and (state.has('Advanced Laser Technology (Wraith)', player)))) and ((state.count('Progressive Terran Ship Weapon', player) >= 1)) and ((state.count('Progressive Terran Ship Armor', player) >= 1)) and ((state.has('Marine', player)) or (state.has('Vulture', player)) or (state.has('Hellion', player)) or (state.has('Son of Korhal', player)) or ((state.has('Reaper', player)) and (state.has('Resource Efficiency (Reaper)', player))))) or (((state.has('Thor', player)) or (state.has('Siege Tank', player))) and ((state.count('Progressive Terran Vehicle Weapon', player) >= 1)) and ((state.count('Progressive Terran Vehicle Armor', player) >= 1)) and ((state.has('Marine', player)) or (state.has('Dominion Trooper', player)) or (state.has('Hellion', player)) or (state.has('Vulture', player)))) or (((state.has('Goliath', player)) or (state.has('Warhound', player))) and ((state.count('Progressive Terran Vehicle Weapon', player) >= 1)) and ((state.count('Progressive Terran Vehicle Armor', player) >= 1)) and (_starcraft2worldgen_terran_sustainable_mech_heal(state, player))))) and (_starcraft2worldgen_terran_competent_anti_air(state, player)) and (_starcraft2worldgen_terran_sustainable_mech_heal(state, player)))
...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        And(Compare(CountItem("Progressive Terran Infantry Armor"), ">=", 3), Compare(CountItem("Progressive Terran Infantry Weapon"), ">=", 3), Compare(CountItem("Progressive Terran Ship Armor"), ">=", 3), Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 3), Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 3), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 3), HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), And(HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), Or(And(Or(Has('Marine'), Has('Dominion Trooper'), Has('Marauder')), Compare(CountItem("Progressive Terran Infantry Weapon"), ">=", 2), Compare(CountItem("Progressive Terran Infantry Armor"), ">=", 1), HelperCall(helper_func=_starcraft2worldgen_terran_bio_heal, helper_name="terran_bio_heal")), And(Or(Has('Banshee'), Has('Battlecruiser'), And(Has('Liberator'), Has('Raid Artillery (Liberator)')), And(Has('Wraith'), Has('Advanced Laser Technology (Wraith)'))), Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 1), Compare(CountItem("Progressive Terran Ship Armor"), ">=", 1), Or(Has('Marine'), Has('Vulture'), Has('Hellion'), Has('Son of Korhal'), And(Has('Reaper'), Has('Resource Efficiency (Reaper)')))), And(Or(Has('Thor'), Has('Siege Tank')), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 1), Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 1), Or(Has('Marine'), Has('Dominion Trooper'), Has('Hellion'), Has('Vulture'))), And(Or(Has('Goliath'), Has('Warhound')), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 1), Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 1), HelperCall(helper_func=_starcraft2worldgen_terran_sustainable_mech_heal, helper_name="terran_sustainable_mech_heal")))), Or(And(Has('Reaper'), Has('Resource Efficiency (Reaper)')), And(True_(), Has('EMP Rounds (Ghost)'), Has('Ghost')), And(True_(), Has('Flechette Missiles (Valkyrie)'), Has('Valkyrie')), Has('Banshee'), Has('Dominion Trooper'), Has('Marine')))
    )
    ...
    world.set_rule(
        ...
        And(And(Compare(CountItem("Progressive Terran Infantry Armor"), ">=", 3), Compare(CountItem("Progressive Terran Infantry Weapon"), ">=", 3), Compare(CountItem("Progressive Terran Ship Armor"), ">=", 3), Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 3), Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 3), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 3), HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), Or(And(Has('ATX Laser Battery (Battlecruiser)'), Has('Battlecruiser')), And(Has('Jump Jets (Siege Tank)'), Has('Siege Tank')))), HelperCall(helper_func=_starcraft2worldgen_terran_common_unit, helper_name="terran_common_unit"), HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"))
    )
    ...
    world.set_rule(
        ...
        Or(And(And(HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), Or(And(Compare(CountItem("Progressive Terran Infantry Armor"), ">=", 1), Compare(CountItem("Progressive Terran Infantry Weapon"), ">=", 2), HelperCall(helper_func=_starcraft2worldgen_terran_bio_heal, helper_name="terran_bio_heal"), Or(Has('Dominion Trooper'), Has('Marauder'), Has('Marine'))), And(Compare(CountItem("Progressive Terran Ship Armor"), ">=", 1), Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 1), Or(And(Has('Advanced Laser Technology (Wraith)'), Has('Wraith')), And(Has('Liberator'), Has('Raid Artillery (Liberator)')), Has('Banshee'), Has('Battlecruiser')), Or(And(Has('Reaper'), Has('Resource Efficiency (Reaper)')), Has('Hellion'), Has('Marine'), Has('Son of Korhal'), Has('Vulture'))), And(Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 1), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 1), HelperCall(helper_func=_starcraft2worldgen_terran_sustainable_mech_heal, helper_name="terran_sustainable_mech_heal"), Or(Has('Goliath'), Has('Warhound'))), And(Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 1), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 1), Or(Has('Dominion Trooper'), Has('Hellion'), Has('Marine'), Has('Vulture')), Or(Has('Siege Tank'), Has('Thor'))))), HelperCall(helper_func=_starcraft2worldgen_terran_air, helper_name="terran_air"), HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), HelperCall(helper_func=_starcraft2worldgen_terran_sustainable_mech_heal, helper_name="terran_sustainable_mech_heal"), Or(And(Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 2), HasAny('Battlecruiser', 'Valkyrie', 'Wraith')), HasAll('Progressive High Impact Payload (Thor)', 'Thor'), HasAny('Cyclone', 'Goliath', 'Viking')), Or(And(HelperCall(helper_func=_starcraft2worldgen_terran_bio_heal, helper_name="terran_bio_heal"), Has('Marauder')), HasAll('Flechette Missiles (Valkyrie)', 'Valkyrie'), HasAll('Liberator', 'Raid Artillery (Liberator)'), HasAny('Banshee', 'Battlecruiser', 'Goliath', 'Thor', 'Viking', 'Warhound', 'Wraith'))), And(Or(Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 2), Has('ATX Laser Battery (Battlecruiser)')), Has('Battlecruiser')))
    )
    ...
    world.set_rule(
        ...
        And(And(Or(And(Or(Has('Banshee'), Has('Battlecruiser'), And(Has('Liberator'), Has('Raid Artillery (Liberator)'))), HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air")), And(HelperCall(helper_func=_starcraft2worldgen_terran_air_anti_air, helper_name="terran_air_anti_air"), Or(Has('Siege Tank'), Has('Thor')), Or(Has('Marine'), Has('Dominion Trooper'), Has('Hellion'), Has('Vulture')), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 1), Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 1), HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"))), Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 2)), Or(And(Or(Has('Command Center Reactor (Command Center)'), Has('Extra Supplies (Command Center)'), Has('Micro-Filtering (Terran)'), Has('Orbital Depots (Terran)')), Has('Tech Reactor (Terran)')), Has('Automated Refinery (Terran)'), Has('MULE (Command Center)')))
    )
    ...
    world.set_rule(
        ...
        And(And(Compare(CountItem("Progressive Terran Infantry Armor"), ">=", 3), Compare(CountItem("Progressive Terran Infantry Weapon"), ">=", 3), Compare(CountItem("Progressive Terran Ship Armor"), ">=", 3), Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 3), Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 3), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 3), HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), Or(And(Has('ATX Laser Battery (Battlecruiser)'), Has('Battlecruiser')), And(Has('Jump Jets (Siege Tank)'), Has('Siege Tank')))), And(Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 2), Or(And(Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 1), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 1), HelperCall(helper_func=_starcraft2worldgen_terran_air_anti_air, helper_name="terran_air_anti_air"), HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), Or(Has('Dominion Trooper'), Has('Hellion'), Has('Marine'), Has('Vulture')), Or(Has('Siege Tank'), Has('Thor'))), And(HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), Or(And(Has('Liberator'), Has('Raid Artillery (Liberator)')), Has('Banshee'), Has('Battlecruiser'))))), Compare(HelperCall(helper_func=_starcraft2worldgen_terran_defense_rating, helper_name="terran_defense_rating", args=(False, True,)), ">=", 8), HelperCall(helper_func=_starcraft2worldgen_terran_common_unit, helper_name="terran_common_unit"), Or(False_(), HelperCall(helper_func=_starcraft2worldgen_marine_medic_upgrade, helper_name="marine_medic_upgrade")))
    )
    ...
    world.set_rule(
        ...
        And(HelperCall(helper_func=_starcraft2worldgen_terran_basic_anti_air, helper_name="terran_basic_anti_air"), Or(And(Or(And(Has('G-4 Clusterbomb (Reaper)'), Has('Reaper')), And(Has('Psionic Lash (Spectre)'), Has('Spectre')), Has('Liberator'), Has('Vulture')), True_()), Has('Banshee'), Has('Cyclone'), Has('Diamondback'), Has('Marauder'), Has('Siege Tank')))
    )

    world.set_rule(
        multiworld.get_location("The Great Train Robbery (Terran): Kill Team", player),
        And(HelperCall(helper_func=_starcraft2worldgen_terran_basic_anti_air, helper_name="terran_basic_anti_air"), Or(And(Or(And(Has('G-4 Clusterbomb (Reaper)'), Has('Reaper')), And(Has('Psionic Lash (Spectre)'), Has('Spectre')), Has('Liberator'), Has('Vulture')), True_()), Has('Banshee'), Has('Cyclone'), Has('Diamondback'), Has('Marauder'), Has('Siege Tank')), Or(False_(), HelperCall(helper_func=_starcraft2worldgen_terran_common_unit, helper_name="terran_common_unit")))
    )
    ...
    world.set_rule(
        ...
        Or(And(Or(And(Has('G-4 Clusterbomb (Reaper)'), Has('Reaper')), And(Has('Psionic Lash (Spectre)'), Has('Spectre')), Has('Liberator'), Has('Vulture')), True_()), Has('Banshee'), Has('Cyclone'), Has('Diamondback'), Has('Marauder'), Has('Siege Tank'))
    )
    ...
    world.set_rule(
        ...
        And(HelperCall(helper_func=_starcraft2worldgen_terran_common_unit, helper_name="terran_common_unit"), Or(And(HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), Or(And(Has('Advanced Laser Technology (Wraith)'), Has('Wraith')), And(Has('Liberator'), Has('Raid Artillery (Liberator)')), Has('Battlecruiser'), Has('Viking'))), And(HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), Or(And(Or(Has('Marine'), Has('Dominion Trooper'), Has('Marauder')), Compare(CountItem("Progressive Terran Infantry Weapon"), ">=", 2), Compare(CountItem("Progressive Terran Infantry Armor"), ">=", 1), HelperCall(helper_func=_starcraft2worldgen_terran_bio_heal, helper_name="terran_bio_heal")), And(Or(Has('Banshee'), Has('Battlecruiser'), And(Has('Liberator'), Has('Raid Artillery (Liberator)')), And(Has('Wraith'), Has('Advanced Laser Technology (Wraith)'))), Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 1), Compare(CountItem("Progressive Terran Ship Armor"), ">=", 1), Or(Has('Marine'), Has('Vulture'), Has('Hellion'), Has('Son of Korhal'), And(Has('Reaper'), Has('Resource Efficiency (Reaper)')))), And(Or(Has('Thor'), Has('Siege Tank')), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 1), Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 1), Or(Has('Marine'), Has('Dominion Trooper'), Has('Hellion'), Has('Vulture'))), And(Or(Has('Goliath'), Has('Warhound')), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 1), Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 1), HelperCall(helper_func=_starcraft2worldgen_terran_sustainable_mech_heal, helper_name="terran_sustainable_mech_heal"))))))
    )
    ...
    world.set_rule(
        ...
        And(And(HelperCall(helper_func=_starcraft2worldgen_terran_common_unit, helper_name="terran_common_unit"), Or(True_(), And(HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), Or(Has('Viking'), Has('Battlecruiser'), And(Has('Wraith'), Has('Advanced Laser Technology (Wraith)')), And(Has('Liberator'), Has('Raid Artillery (Liberator)')))))), Or(And(Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 2), Or(Has('Battlecruiser'), Has('Valkyrie'))), HelperCall(helper_func=_starcraft2worldgen_terran_air_anti_air, helper_name="terran_air_anti_air")))
    )
    ...
    world.set_rule(
        ...
        And(HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), Or(And(Compare(CountItem("Progressive Terran Infantry Armor"), ">=", 2), Compare(CountItem("Progressive Terran Infantry Weapon"), ">=", 3), HelperCall(helper_func=_starcraft2worldgen_terran_bio_heal, helper_name="terran_bio_heal"), Or(Has('Dominion Trooper'), Has('Marauder'), Has('Marine'))), And(Compare(CountItem("Progressive Terran Ship Armor"), ">=", 2), Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 2), Or(And(Has('Advanced Laser Technology (Wraith)'), Has('Wraith')), And(Has('Liberator'), Has('Raid Artillery (Liberator)')), Has('Banshee'), Has('Battlecruiser')), Or(And(Has('Reaper'), Has('Resource Efficiency (Reaper)')), Has('Hellion'), Has('Marine'), Has('Son of Korhal'), Has('Vulture'))), And(Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 2), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 2), HelperCall(helper_func=_starcraft2worldgen_terran_sustainable_mech_heal, helper_name="terran_sustainable_mech_heal"), Or(Has('Goliath'), Has('Warhound'))), And(Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 2), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 2), Or(Has('Dominion Trooper'), Has('Hellion'), Has('Marine'), Has('Vulture')), Or(Has('Siege Tank'), Has('Thor')))))
    )
    ...
    world.set_rule(
        ...
        And(And(Compare(CountItem("Progressive Terran Infantry Armor"), ">=", 3), Compare(CountItem("Progressive Terran Infantry Weapon"), ">=", 3), Compare(CountItem("Progressive Terran Ship Armor"), ">=", 3), Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 3), Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 3), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 3), HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), Or(And(Has('ATX Laser Battery (Battlecruiser)'), Has('Battlecruiser')), And(Has('Jump Jets (Siege Tank)'), Has('Siege Tank')))), And(Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 2), Or(And(Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 1), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 1), HelperCall(helper_func=_starcraft2worldgen_terran_air_anti_air, helper_name="terran_air_anti_air"), HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), Or(Has('Dominion Trooper'), Has('Hellion'), Has('Marine'), Has('Vulture')), Or(Has('Siege Tank'), Has('Thor'))), And(HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), Or(And(Has('Liberator'), Has('Raid Artillery (Liberator)')), Has('Banshee'), Has('Battlecruiser'))))), Or(And(Compare(CountItem("Progressive Terran Infantry Weapon"), ">=", 2), Or(Has('Dominion Trooper'), Has('Marine')), Or(Has('Medic'), Has('Medivac'))), Has('Goliath')))
    )

    world.set_rule(
        multiworld.get_location("Welcome to the Jungle (Terran): No Terrazine Nodes Sealed", player),
        And(And(Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 2), Or(And(Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 1), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 1), HelperCall(helper_func=_starcraft2worldgen_terran_air_anti_air, helper_name="terran_air_anti_air"), HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), Or(Has('Dominion Trooper'), Has('Hellion'), Has('Marine'), Has('Vulture')), Or(Has('Siege Tank'), Has('Thor'))), And(HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), Or(And(Has('Liberator'), Has('Raid Artillery (Liberator)')), Has('Banshee'), Has('Battlecruiser'))))), Or(And(Compare(CountItem("Progressive Terran Infantry Weapon"), ">=", 2), HelperCall(helper_func=_starcraft2worldgen_terran_bio_heal, helper_name="terran_bio_heal"), Or(Has('Dominion Trooper'), Has('Marine'))), And(True_(), Has('Cyclone')), And(True_(), Has('Progressive High Impact Payload (Thor)'), Has('Thor')), Has('Goliath')), Or(And(Compare(CountItem("Progressive Terran Infantry Weapon"), ">=", 2), Or(Has('Dominion Trooper'), Has('Marine')), Or(Has('Medic'), Has('Medivac'))), Has('Goliath')))
    )
    ...
    world.set_rule(
        ...
        And(And(HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), Or(And(Compare(CountItem("Progressive Terran Infantry Armor"), ">=", 1), Compare(CountItem("Progressive Terran Infantry Weapon"), ">=", 2), HelperCall(helper_func=_starcraft2worldgen_terran_bio_heal, helper_name="terran_bio_heal"), Or(Has('Dominion Trooper'), Has('Marauder'), Has('Marine'))), And(Compare(CountItem("Progressive Terran Ship Armor"), ">=", 1), Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 1), Or(And(Has('Advanced Laser Technology (Wraith)'), Has('Wraith')), And(Has('Liberator'), Has('Raid Artillery (Liberator)')), Has('Banshee'), Has('Battlecruiser')), Or(And(Has('Reaper'), Has('Resource Efficiency (Reaper)')), Has('Hellion'), Has('Marine'), Has('Son of Korhal'), Has('Vulture'))), And(Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 1), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 1), HelperCall(helper_func=_starcraft2worldgen_terran_sustainable_mech_heal, helper_name="terran_sustainable_mech_heal"), Or(Has('Goliath'), Has('Warhound'))), And(Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 1), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 1), Or(Has('Dominion Trooper'), Has('Hellion'), Has('Marine'), Has('Vulture')), Or(Has('Siege Tank'), Has('Thor'))))), Or(And(Compare(CountItem("Progressive Terran Infantry Weapon"), ">=", 2), Or(Has('Dominion Trooper'), Has('Marine')), Or(Has('Medic'), Has('Medivac'))), Has('Goliath')))
    )
    ...
    world.set_rule(
        ...
        Or(And(HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), Or(And(Compare(CountItem("Progressive Terran Infantry Armor"), ">=", 1), Compare(CountItem("Progressive Terran Infantry Weapon"), ">=", 2), HelperCall(helper_func=_starcraft2worldgen_terran_bio_heal, helper_name="terran_bio_heal"), Or(Has('Dominion Trooper'), Has('Marauder'), Has('Marine'))), And(Compare(CountItem("Progressive Terran Ship Armor"), ">=", 1), Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 1), Or(And(Has('Advanced Laser Technology (Wraith)'), Has('Wraith')), And(Has('Liberator'), Has('Raid Artillery (Liberator)')), Has('Banshee'), Has('Battlecruiser')), Or(And(Has('Reaper'), Has('Resource Efficiency (Reaper)')), Has('Hellion'), Has('Marine'), Has('Son of Korhal'), Has('Vulture'))), And(Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 1), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 1), HelperCall(helper_func=_starcraft2worldgen_terran_sustainable_mech_heal, helper_name="terran_sustainable_mech_heal"), Or(Has('Goliath'), Has('Warhound'))), And(Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 1), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 1), Or(Has('Dominion Trooper'), Has('Hellion'), Has('Marine'), Has('Vulture')), Or(Has('Siege Tank'), Has('Thor'))))), False_())
    )
