...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        And(Compare(CountItem("Progressive Terran Infantry Armor"), ">=", 3), Compare(CountItem("Progressive Terran Infantry Weapon"), ">=", 3), Compare(CountItem("Progressive Terran Ship Armor"), ">=", 3), Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 3), Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 3), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 3), True_(), Or(And(Has('EMP Rounds (Ghost)'), Has('Ghost')), And(Has('Flechette Missiles (Valkyrie)'), Has('Valkyrie')), And(Has('Reaper'), Has('Resource Efficiency (Reaper)')), Has('Banshee'), Has('Dominion Trooper'), Has('Marine')))
    )
    ...
    world.set_rule(
        ...
        And(And(Compare(CountItem("Progressive Terran Infantry Armor"), ">=", 2), Compare(CountItem("Progressive Terran Infantry Weapon"), ">=", 2), Compare(CountItem("Progressive Terran Ship Armor"), ">=", 2), Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 2), Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 2), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 2), HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), Or(And(Has('Liberator'), Has('Raid Artillery (Liberator)')), Has('Banshee'), Has('Battlecruiser'))), Compare(100, ">=", 6))
    )
    ...
    world.set_rule(
        ...
        And(And(Compare(CountItem("Progressive Terran Infantry Armor"), ">=", 2), Compare(CountItem("Progressive Terran Infantry Weapon"), ">=", 2), Compare(CountItem("Progressive Terran Ship Armor"), ">=", 2), Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 2), Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 2), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 2), HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), Or(And(Has('Liberator'), Has('Raid Artillery (Liberator)')), Has('Banshee'), Has('Battlecruiser'))), And(Compare(CountItem("Progressive Terran Infantry Armor"), ">=", 3), Compare(CountItem("Progressive Terran Infantry Weapon"), ">=", 3), Compare(CountItem("Progressive Terran Ship Armor"), ">=", 3), Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 3), Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 3), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 3), HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), Or(And(Has('ATX Laser Battery (Battlecruiser)'), Has('Battlecruiser')), And(Has('Jump Jets (Siege Tank)'), Has('Siege Tank')))), Compare(HelperCall(helper_func=_starcraft2worldgen_terran_defense_rating, helper_name="terran_defense_rating", args=(False, True,)), ">=", 8), HelperCall(helper_func=_starcraft2worldgen_terran_common_unit, helper_name="terran_common_unit"), Or(False_(), HelperCall(helper_func=_starcraft2worldgen_marine_medic_upgrade, helper_name="marine_medic_upgrade")))
    )
    ...
    world.set_rule(
        ...
        And(True_(), Or(And(Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 2), Or(Has('Battlecruiser'), Has('Valkyrie'))), HelperCall(helper_func=_starcraft2worldgen_terran_air_anti_air, helper_name="terran_air_anti_air")))
    )
    ...
    world.set_rule(
        ...
        And(And(Compare(CountItem("Progressive Terran Infantry Armor"), ">=", 2), Compare(CountItem("Progressive Terran Infantry Weapon"), ">=", 2), Compare(CountItem("Progressive Terran Ship Armor"), ">=", 2), Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 2), Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 2), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 2), HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), Or(And(Has('Liberator'), Has('Raid Artillery (Liberator)')), Has('Banshee'), Has('Battlecruiser'))), And(Compare(CountItem("Progressive Terran Infantry Armor"), ">=", 3), Compare(CountItem("Progressive Terran Infantry Weapon"), ">=", 3), Compare(CountItem("Progressive Terran Ship Armor"), ">=", 3), Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 3), Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 3), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 3), HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), Or(And(Has('ATX Laser Battery (Battlecruiser)'), Has('Battlecruiser')), And(Has('Jump Jets (Siege Tank)'), Has('Siege Tank')))), Or(And(Compare(CountItem("Progressive Terran Infantry Weapon"), ">=", 2), Or(Has('Dominion Trooper'), Has('Marine')), Or(Has('Medic'), Has('Medivac'))), Has('Goliath')))
    )

    world.set_rule(
        multiworld.get_location("Welcome to the Jungle (Terran): No Terrazine Nodes Sealed", player),
        And(And(Compare(CountItem("Progressive Terran Infantry Armor"), ">=", 2), Compare(CountItem("Progressive Terran Infantry Weapon"), ">=", 2), Compare(CountItem("Progressive Terran Ship Armor"), ">=", 2), Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 2), Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 2), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 2), HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), Or(And(Has('Liberator'), Has('Raid Artillery (Liberator)')), Has('Banshee'), Has('Battlecruiser'))), Or(And(Compare(CountItem("Progressive Terran Infantry Weapon"), ">=", 2), Or(Has('Dominion Trooper'), Has('Marine')), Or(Has('Medic'), Has('Medivac'))), Has('Goliath')), Or(Has('Cyclone'), Has('Goliath'), Has('Thor')))
    )
