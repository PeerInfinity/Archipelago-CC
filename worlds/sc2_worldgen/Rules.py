...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        And(Compare(CountItem("Progressive Terran Infantry Armor"), ">=", 3), Compare(CountItem("Progressive Terran Infantry Weapon"), ">=", 3), Compare(CountItem("Progressive Terran Ship Armor"), ">=", 3), Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 3), Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 3), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 3), HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), Or(And(Has('EMP Rounds (Ghost)'), Has('Ghost')), And(Has('Flechette Missiles (Valkyrie)'), Has('Valkyrie')), And(Has('Reaper'), Has('Resource Efficiency (Reaper)')), Has('Banshee'), Has('Dominion Trooper'), Has('Marine')))
    )
    ...
    world.set_rule(
        ...
        And(And(Compare(CountItem("Progressive Terran Infantry Armor"), ">=", 2), Compare(CountItem("Progressive Terran Infantry Weapon"), ">=", 2), Compare(CountItem("Progressive Terran Ship Armor"), ">=", 2), Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 2), Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 2), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 2), HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), Or(Has('Banshee'), Has('Battlecruiser'))), Compare(HelperCall(helper_func=_starcraft2worldgen_terran_power_rating, helper_name="terran_power_rating"), ">=", 6))
    )
    ...
    world.set_rule(
        ...
        And(HelperCall(helper_func=_starcraft2worldgen_terran_competent_anti_air, helper_name="terran_competent_anti_air"), Or(And(Compare(CountItem("Progressive Terran Infantry Armor"), ">=", 2), Compare(CountItem("Progressive Terran Infantry Weapon"), ">=", 3), HelperCall(helper_func=_starcraft2worldgen_terran_bio_heal, helper_name="terran_bio_heal"), Or(Has('Dominion Trooper'), Has('Marauder'), Has('Marine'))), And(Compare(CountItem("Progressive Terran Ship Armor"), ">=", 2), Compare(CountItem("Progressive Terran Ship Weapon"), ">=", 2), True_(), Or(Has('Banshee'), Has('Battlecruiser'))), And(Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 2), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 2), HelperCall(helper_func=_starcraft2worldgen_terran_sustainable_mech_heal, helper_name="terran_sustainable_mech_heal"), Or(Has('Goliath'), Has('Warhound'))), And(Compare(CountItem("Progressive Terran Vehicle Armor"), ">=", 2), Compare(CountItem("Progressive Terran Vehicle Weapon"), ">=", 2), Or(Has('Dominion Trooper'), Has('Hellion'), Has('Marine'), Has('Vulture')), Or(Has('Siege Tank'), Has('Thor')))))
    )
