...
from rule_builder import True_, False_, And, CanReachEntrance, CanReachRegion, Has, HasAll, HelperCall, Or
...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        Or(HasAll('Left Home Key', 'Right Home Key'), Has('Key Piece', 5))
    )
    # Location rules
    world.set_rule(
