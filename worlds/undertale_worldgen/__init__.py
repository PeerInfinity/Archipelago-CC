"""
Undertale world implementation for Archipelago.
...
from .Items import item_table, UndertaleItem
...
class UndertaleWorld(RuleWorldMixin, World):
    ...
    game: ClassVar[str] = "Undertale"
    web: ClassVar[WebWorld] = UndertaleWeb()
    ...
    def create_item(self, name: str) -> Item:
        ...
        return UndertaleItem(name, data.classification, data.id, self.player)
