...
from rule_builder import True_, False_, CanReachRegion, Has, HasAll
...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        (CanReachRegion("DDD: Board Bowser's Sub")) & (Has("Power Star", 26))
    )
    ...
    world.set_rule(
        ...
        (CanReachRegion("Basement")) & (Has("Power Star", 12))
    )

    world.set_rule(
        multiworld.get_location("Toad (Second Floor)", player),
        (CanReachRegion("Second Floor")) & (Has("Power Star", 25))
    )

    world.set_rule(
        multiworld.get_location("Toad (Third Floor)", player),
        (CanReachRegion("Third Floor")) & (Has("Power Star", 35))
    )

    world.set_rule(
        multiworld.get_location("MIPS 1", player),
        (CanReachRegion("Basement")) & (Has("Power Star", 13))
    )

    world.set_rule(
        multiworld.get_location("MIPS 2", player),
        (CanReachRegion("Basement")) & (Has("Power Star", 44))
    )
    ...
    world.set_rule(
        ...
        CanReachRegion("Bowser in the Fire Sea Key")
    )
