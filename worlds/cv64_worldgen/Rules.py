...
from rule_builder import True_, False_, And, False_, Has, HasAll, Or, True_
...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        Or(False_(), Or(False_(), Or(False_(), Has('Storeroom Key'))))
    )

    world.set_rule(
        multiworld.get_entrance("To Archives door", player),
        Or(False_(), Or(False_(), Has('Archives Key')))
    )
    ...
    world.set_rule(
        ...
        Or(False_(), Or(False_(), Or(False_(), Or(False_(), Has('Chamber Key')))))
    )
    ...
    world.set_rule(
        ...
        Or(False_(), Or(False_(), Has('Science Key3')))
    )
