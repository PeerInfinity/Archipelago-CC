"""
TOEM original WorldGen world implementation for Archipelago.
...
from .Items import item_table, ItemData, TOEMoriginalWorldGenItem
from .Locations import location_table, TOEMoriginalWorldGenLocation
from .Options import TOEMoriginalWorldGenOptions
...
class TOEMoriginalWorldGenWeb(WebWorld):
    """Web interface for TOEM original WorldGen."""
    theme = "grassFlowers"
    tutorials = [
        Tutorial(
            "Setup Guide",
...
class TOEMoriginalWorldGenWorld(RuleWorldMixin, World):
    """
    TOEM original WorldGen for Archipelago.

    Auto-generated world implementation.
    """

    game: ClassVar[str] = "TOEM original WorldGen"
    web: ClassVar[WebWorld] = TOEMoriginalWorldGenWeb()

    options_dataclass = TOEMoriginalWorldGenOptions
    ...
    def create_item(self, name: str) -> Item:
        ...
        return TOEMoriginalWorldGenItem(name, data.classification, data.id, self.player)
