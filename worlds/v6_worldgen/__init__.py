...
class V6World(RuleWorldMixin, World):
    ...
    canonical_placement_advancements: ClassVar[Dict[str, bool]] = {
        "Overworld (Pipe-shaped Segment)": False,
        "Overworld (Left of Ship)": True,
        "Overworld (Square Room)": True,
        "Overworld (Sad Elephant)": True,
        "It's a Secret to Nobody": False,
        "Trench Warfare": True,
        "NPC Trinket": True,
        "V": False,
        "Young Man, It's Worth the Challenge": True,
    ...
    def generate_basic(self) -> None:
        ...
        self.multiworld.completion_condition[self.player] = \
            lambda state: state.can_reach("V", "Location", self.player)
