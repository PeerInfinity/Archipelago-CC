...
from rule_builder import True_, False_, And, Arithmetic, Compare, Conditional, CountItem, False_, Has, HasAny, HasFromListUnique, Not, Or, True_
...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        Or(And(Not(False_()), Has('Carrot')), Has('Hippo Bubble'))
    )
    ...
    world.set_rule(
        ...
        Or(And(Not(False_()), Has('Carrot')), HasAny('Hippo Bubble', 'Water Physics'))
    )
    ...
    world.set_rule(
        ...
        And(Not(False_()), HasAny('Carrot', 'Space Physics'))
    )

    world.set_rule(
        multiworld.get_location("Space Zone 2 - Boss", player),
        Conditional(test=HasAny('Pipe Traversal', 'Pipe Traversal - Right'), if_true=Or(Conditional(test=Or(Not(False_()), Has('Space Zone 2 Midway Bell')), if_true=True_(), if_false=True_()), Has('Space Physics')), if_false=False_())
    )
    ...
    world.set_rule(
        ...
        And(Not(False_()), Or(HasAny('Pipe Traversal', 'Pipe Traversal - Down'), Has('Macro Zone 2 Midway Bell')), HasAny('Pipe Traversal', 'Pipe Traversal - Up'), Has('Water Physics'))
    )
    ...
    world.set_rule(
        ...
        Or(And(Not(False_()), HasAny('Pipe Traversal', 'Pipe Traversal - Down')), Has('Pumpkin Zone 1 Midway Bell'))
    )
    ...
    world.set_rule(
        ...
        And(Not(False_()), HasAny('Pipe Traversal', 'Pipe Traversal - Down'), HasAny('Pipe Traversal', 'Pipe Traversal - Right'), HasAny('Pipe Traversal', 'Pipe Traversal - Up'), Has('Water Physics'))
    )

    world.set_rule(
        multiworld.get_location("Pumpkin Zone 2 - Secret Exit", player),
        And(And(Not(False_()), HasAny('Pipe Traversal', 'Pipe Traversal - Down'), HasAny('Pipe Traversal', 'Pipe Traversal - Right'), HasAny('Pipe Traversal', 'Pipe Traversal - Up'), Has('Water Physics')), HasAny('Fire Flower', 'Mushroom'))
    )
    ...
    world.set_rule(
        ...
        And(Or(Not(False_()), HasAny('Carrot', 'Fire Flower', 'Mario Zone 1 Midway Bell', 'Mushroom')), HasAny('Pipe Traversal', 'Pipe Traversal - Right'))
    )
    ...
    world.set_rule(
        ...
        And(Not(False_()), HasAny('Pipe Traversal', 'Pipe Traversal - Down'), HasAny('Pipe Traversal', 'Pipe Traversal - Left'), HasAny('Pipe Traversal', 'Pipe Traversal - Right'), HasAny('Pipe Traversal', 'Pipe Traversal - Up'), Has('Water Physics'))
    )

    world.set_rule(
        multiworld.get_location("Turtle Zone 2 - Secret Exit", player),
        And(Not(False_()), HasAny('Pipe Traversal', 'Pipe Traversal - Up'), Has('Water Physics'))
    )

    world.set_rule(
        multiworld.get_location("Turtle Zone 2 - Midway Bell", player),
        Or(And(Not(False_()), Has('Water Physics')), Has('Turtle Zone 2 Midway Bell'))
    )
