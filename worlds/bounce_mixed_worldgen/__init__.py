"""
Bounce Mixed WorldGen world implementation for Archipelago.
...
from .Items import item_table, ItemData, BounceMixedWorldGenItem
from .Locations import location_table, BounceMixedWorldGenLocation
from .Options import BounceMixedWorldGenOptions
...
class BounceMixedWorldGenWeb(WebWorld):
    """Web interface for Bounce Mixed WorldGen."""
    theme = "ocean"
    game_info_languages: List[str] = ['en']
    tutorials = [
        Tutorial(
            "Multiworld Setup Guide",
            "A guide to setting up the Bounce Mixed WorldGen world for Archipelago.",
            "English",
            "setup_en.md",
            "setup/en",
            ["Auto-generated"]
...
class ProcgenMazeWorld(RuleWorldMixin, World):
    """
    Bounce Mixed WorldGen for Archipelago.

    Auto-generated world implementation.
    """

    game: ClassVar[str] = "Bounce Mixed WorldGen"
    web: ClassVar[WebWorld] = BounceMixedWorldGenWeb()

    options_dataclass = BounceMixedWorldGenOptions
    options: BounceMixedWorldGenOptions
    ...
    def create_item(self, name: str) -> Item:
        ...
        item = BounceMixedWorldGenItem(name, data.classification, data.id, self.player)
        return item
