"""
Baking Adventure Vanilla WorldGen2 world implementation for Archipelago.
...
from .Items import item_table, ItemData, BakingAdventureVanillaWorldGen2Item
from .Locations import location_table, BakingAdventureVanillaWorldGen2Location
from .Options import BakingAdventureVanillaWorldGen2Options
...
class BakingAdventureVanillaWorldGen2Web(WebWorld):
    """Web interface for Baking Adventure Vanilla WorldGen2."""
    theme = "partyTime"
...
class BakingAdventureWorld(RuleWorldMixin, World):
    ...
    game: ClassVar[str] = "Baking Adventure Vanilla WorldGen2"
    web: ClassVar[WebWorld] = BakingAdventureVanillaWorldGen2Web()

    options_dataclass = BakingAdventureVanillaWorldGen2Options
            ...
            if classification_counts:
                ...
                for classification_name, class_count in classification_counts.items():
                    ...
                    for _ in range(class_count):
                        item = BakingAdventureVanillaWorldGen2Item(
                            item_name,
                            classification,
                            item_data.id,
                            self.player
    ...
    def generate_basic(self) -> None:
        ...
        if victory_location.item is None:
            victory_item = BakingAdventureVanillaWorldGen2Item(
                "Victory",
    ...
    def create_item(self, name: str) -> Item:
        ...
        item = BakingAdventureVanillaWorldGen2Item(name, data.classification, data.id, self.player)
        return item
