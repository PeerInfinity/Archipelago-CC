"""
Location definitions for Baking Adventure Vanilla WorldGen2.
...
class BakingAdventureVanillaWorldGen2Location(Location):
    """Location class for Baking Adventure Vanilla WorldGen2."""
