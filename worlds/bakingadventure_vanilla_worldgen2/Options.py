"""
Game options for Baking Adventure Vanilla WorldGen2.
...
@dataclass
class BakingAdventureVanillaWorldGen2Options(PerGameCommonOptions):
    """Options for Baking Adventure Vanilla WorldGen2."""
