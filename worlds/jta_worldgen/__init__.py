"""
Journey to Ascension WorldGen world implementation for Archipelago.
...
from .Items import item_table, ItemData, JourneytoAscensionWorldGenItem
from .Locations import location_table, JourneytoAscensionWorldGenLocation
from .Options import JourneytoAscensionWorldGenOptions
...
class JourneytoAscensionWorldGenWeb(WebWorld):
    """Web interface for Journey to Ascension WorldGen."""
    theme = "ocean"
...
class JTAWorld(RuleWorldMixin, World):
    ...
    game: ClassVar[str] = "Journey to Ascension WorldGen"
    web: ClassVar[WebWorld] = JourneytoAscensionWorldGenWeb()

    options_dataclass = JourneytoAscensionWorldGenOptions
    options: JourneytoAscensionWorldGenOptions
    ...
    canonical_placements: ClassVar[Dict[str, str]] = {
        "Learn How to Read": "High Altitude Climbing",
        "Learn How to Write": "Attunement",
        "Rescue Villager": "Reflections on the Journey",
        "Save the Village": "Minor Time Compression",
        "Find an Amulet": "Purged Bureaucracy",
        "Try Casting a Spell": "Understanding of the Reset",
        "Wipe Out Goblins": "Village Hero",
        "Get Used to Traveling": "Goblin Scourge",
        "Study the Amulet": "Villager Gratitude",
        "Negotiate with a Rogue Guard": "Walk Without Rhythm",
        "Cast a Spell": "Sunken Treasure",
        "Purge Corrupt Bureaucracy": "How to Read",
        "Scale the Mountain": "Deep Sea Diving",
        "Figure Out How to Attune": "Energetic Spell",
        "Dive as a Squid": "Found Lost Temple",
        "Explore Kraken's Lair": "Energetic Memory",
        "Explore the Jungle": "Underground Connection",
        "Avoid Notice by the Sandworm": "The Worm",
        "Learn to Dance the Worm": "Experienced Traveler",
        "Reflect on the Journey": "How to Write",
        "Practice Memorization": "Mysterious Amulet",
        "Reach Goal Zone": "Victory",
    }
    ...
    def __init__(self, multiworld: "MultiWorld", player: int):
        ...
        self.slot_data = {'game': 'Journey to Ascension', 'version': '0.5.0', 'goalZone': 15, 'resetsPerSphere': 5, 'costGenFactors': {'itemCollection': True, 'pushCollect': True, 'grindWithPushCollect': True, 'artifacts': True}, 'automation': {'autoQueue': True, 'autoReset': True, 'drainStrategy': True, 'loadoutSequencing': True}, 'perkPlacements': {13: 'High Altitude Climbing', 27: 'Attunement', 34: 'Reflections on the Journey', 37: 'Minor Time Compression', 43: 'Purged Bureaucracy', 54: 'Understanding of the Reset', 58: 'Village Hero', 64: 'Goblin Scourge', 69: 'Villager Gratitude', 74: 'Walk Without Rhythm', 84: 'Sunken Treasure', 89: 'How to Read', 90: 'Deep Sea Diving', 104: 'Energetic Spell', 114: 'Found Lost Temple', 118: 'Energetic Memory', 124: 'Underground Connection', 134: 'The Worm', 138: 'Experienced Traveler', 144: 'How to Write', 155: 'Mysterious Amulet'}}
            ...
            if classification_counts:
                ...
                for classification_name, class_count in classification_counts.items():
                    ...
                    for _ in range(class_count):
                        item = JourneytoAscensionWorldGenItem(
                            item_name,
                            classification,
                            item_data.id,
                            self.player
    ...
    def generate_basic(self) -> None:
        ...
        if victory_location.item is None:
            victory_item = JourneytoAscensionWorldGenItem(
                "Victory",
    ...
    def create_item(self, name: str) -> Item:
        ...
        item = JourneytoAscensionWorldGenItem(name, data.classification, data.id, self.player)
        return item
