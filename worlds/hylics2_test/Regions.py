"""
Region definitions for Hylics 2 Test.
...
def create_regions(multiworld: MultiWorld, player: int) -> None:
    ...
    # Create all regions
    region_names = ["Afterlife", "Airship", "Arcade Island", "Drill Castle", "Foglast", "Hylemxylem", "Juice Ranch", "Menu", "New Muldul", "New Muldul Vault", "Sage Airship", "Sage Labyrinth", "Shield Facility", "TV Island", "Viewax", "Waynehouse", "World", "Worm Pod"]
