"""
Runner WorldGen world implementation for Archipelago.
...
from .Items import item_table, ItemData, RunnerWorldGenItem
from .Locations import location_table, RunnerWorldGenLocation
from .Options import RunnerWorldGenOptions
...
class RunnerWorldGenWeb(WebWorld):
    """Web interface for Runner WorldGen."""
    theme = "ocean"
    game_info_languages: List[str] = ['en']
    tutorials = [
        Tutorial(
            "Multiworld Setup Guide",
            "A guide to setting up the Runner WorldGen world for Archipelago.",
            "English",
            "setup_en.md",
            "setup/en",
            ["Auto-generated"]
...
class ProcgenMazeWorld(RuleWorldMixin, World):
    """
    Runner WorldGen for Archipelago.
    
    Auto-generated world implementation.
    """

    game: ClassVar[str] = "Runner WorldGen"
    web: ClassVar[WebWorld] = RunnerWorldGenWeb()

    options_dataclass = RunnerWorldGenOptions
    options: RunnerWorldGenOptions
    ...
    item_name_groups: ClassVar[Dict[str, frozenset]] = {
        "Everything": frozenset(["Victory", "Shield", "Springs", "Glide", "Double Jump", "Blue Platforms"]),
    }
    ...
    canonical_placements: ClassVar[Dict[str, str]] = {
        "region_0_0__loc_0": "Victory",
        "region_1_0__loc_0": "Shield",
        "region_2_0__loc_0": "Springs",
        "region_0_1__loc_0": "Glide",
        "region_1_1__loc_0": "Double Jump",
        "region_2_1__loc_0": "Blue Platforms",
    }
    ...
    def __init__(self, multiworld: "MultiWorld", player: int):
        ...
        self.world_description = 'Runner WorldGen for Archipelago.\n\nAuto-generated world implementation.'
    ...
    def create_item(self, name: str) -> Item:
        ...
        item = RunnerWorldGenItem(name, data.classification, data.id, self.player)
        return item
