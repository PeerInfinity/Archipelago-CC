"""
UT Pickle Mode WorldGen world implementation for Archipelago.
...
from .Items import item_table, ItemData, UTPickleModeWorldGenItem
from .Locations import location_table, UTPickleModeWorldGenLocation
from .Options import UTPickleModeWorldGenOptions
...
class UTPickleModeWorldGenWeb(WebWorld):
    """Web interface for UT Pickle Mode WorldGen."""
    theme = "grass"
    game_info_languages: List[str] = ['en']
    tutorials = [
        Tutorial(
            "Multiworld Setup Guide",
            "A guide to setting up the UT Pickle Mode WorldGen world for Archipelago.",
            "English",
            "setup_en.md",
            "setup/en",
            ["Auto-generated"]
...
class TrackerWorld(RuleWorldMixin, World):
    """
    UT Pickle Mode WorldGen for Archipelago.

    Auto-generated world implementation.
    """

    game: ClassVar[str] = "UT Pickle Mode WorldGen"
    web: ClassVar[WebWorld] = UTPickleModeWorldGenWeb()

    options_dataclass = UTPickleModeWorldGenOptions
    options: UTPickleModeWorldGenOptions
    ...
    def __init__(self, multiworld: "MultiWorld", player: int):
        ...
        self.world_class_name = 'TrackerWorld'
    ...
    def create_item(self, name: str) -> Item:
        ...
        item = UTPickleModeWorldGenItem(name, data.classification, data.id, self.player)
        return item
