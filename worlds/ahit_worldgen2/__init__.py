...
class HatInTimeWorld(RuleWorldMixin, World):
    ...
    item_name_groups: ClassVar[Dict[str, frozenset]] = {
        ...
        "Event": frozenset(["AFR Access", "HUMT Access", "Birdhouse Cleared", "Time Piece Cluster", "TIHS Access", "Lava Cake Cleared", "Twilight Bell Cleared", "Windmill Cleared", "TOD Access"]),
    }
