"""
Game options for DepGraph Recipe Chain Vanilla WorldGen.
...
@dataclass
class DepGraphRecipeChainVanillaWorldGenOptions(PerGameCommonOptions):
    """Options for DepGraph Recipe Chain Vanilla WorldGen."""
