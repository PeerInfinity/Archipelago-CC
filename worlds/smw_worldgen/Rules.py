"""
Access rules for Super Mario World WorldGen WorldGen.
...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        (((Has("Progressive Powerup", 3)) & (Has("Run"))) | (Has("Green Switch Palace")) | (Has("Yoshi"))) & (Has("Carry"))
    )

    world.set_rule(
        multiworld.get_entrance("Donut Plains 2 -> Donut Plains 2 - Secret Exit", player),
        (((Has("Climb")) & (Has("Progressive Powerup")) & (Has("Spin Jump"))) | (Has("Yoshi"))) & (Has("Carry"))
    )
    ...
    world.set_rule(
        ...
        (((Has("Progressive Powerup", 3)) & (Has("Run"))) | (Has("Climb"))) & (Has("Carry")) & (Has("P-Switch"))
    )
    ...
    world.set_rule(
        ...
        ((Has("Progressive Powerup")) | (Has("Super Star Activate"))) & (Has("Run"))
    )

    world.set_rule(
        multiworld.get_entrance("Vanilla Dome 1 -> Vanilla Dome 1 - Secret Exit", player),
        (((Has("Climb")) & (Has("Red Switch Palace"))) | ((Has("Climb")) & (Has("Yoshi"))) | ((Has("Red Switch Palace")) & (Has("Yoshi")))) & (Has("Carry"))
    )

    world.set_rule(
        multiworld.get_entrance("Vanilla Dome 2 -> Vanilla Dome 2 - Normal Exit", player),
        ((Has("Climb")) | (Has("Yoshi"))) & (Has("Swim"))
    )

    world.set_rule(
        multiworld.get_entrance("Vanilla Dome 2 -> Vanilla Dome 2 - Secret Exit", player),
        ((Has("Climb")) | (Has("Yoshi"))) & (Has("Carry")) & (Has("P-Switch")) & (Has("Swim"))
    )
    ...
    world.set_rule(
        ...
        ((Has("Blue Switch Palace")) & (Has("Carry"))) & (Has("Climb"))
    )
    ...
    world.set_rule(
        ...
        ((Has("Progressive Powerup", 3)) | (Has("Yoshi"))) & (Has("Run"))
    )
    ...
    world.set_rule(
        ...
        (Has("Carry")) & (Has("Progressive Powerup")) & (Has("Spin Jump"))
    )
    ...
    world.set_rule(
        ...
        (Has("Carry")) & (Has("P-Switch")) & (Has("Run"))
    )
    ...
    world.set_rule(
        ...
        (Has("Progressive Powerup")) & (Has("Spin Jump"))
    )
    ...
    world.set_rule(
        ...
        (((Has("Green Switch Palace")) & (Has("Red Switch Palace"))) | (Has("Yoshi"))) & (Has("Carry"))
    )
    ...
    world.set_rule(
        ...
        (Has("Blue Switch Palace")) & (Has("Carry")) & (Has("Climb")) & (Has("Green Switch Palace")) & (Has("P-Switch")) & (Has("Red Switch Palace")) & (Has("Yellow Switch Palace"))
    )

    world.set_rule(
        multiworld.get_entrance("Gnarly -> Gnarly - Normal Exit", player),
        (((Has("Progressive Powerup", 3)) & (Has("Run"))) | (Has("P-Switch"))) & (Has("Climb"))
    )
    ...
    world.set_rule(
        ...
        (Has("Progressive Powerup", 2)) | (Has("Super Star Activate"))
    )
    ...
    world.set_rule(
        ...
        ((Has("Progressive Powerup")) & (Has("Spin Jump"))) | (Has("Carry")) | (Has("Progressive Powerup", 3)) | (Has("Yoshi"))
    )
    # Location rules
    world.set_rule(
