...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        And(Or(Has('Chaingun'), Has('Shotgun')), Has('Nuclear Plant (E1M2)'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Chaingun'), Has('Phobos Lab (E1M5)'), Has('Shotgun'))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> Central Processing (E1M6) Main", player),
        And(Has('Central Processing (E1M6)'), Has('Chaingun'), Has('Rocket launcher'), Has('Shotgun'))
    )
    ...
    world.set_rule(
        ...
        And(And(Has('Chaingun'), Has('Phobos Anomaly (E1M8)'), Has('Shotgun')), Or(Has('BFG9000'), Has('Plasma gun'), Has('Rocket launcher')))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> Military Base (E1M9) Main", player),
        And(Has('Chaingun'), Has('Military Base (E1M9)'), Has('Shotgun'))
    )
    ...
    world.set_rule(
        ...
        And(And(Has('Containment Area (E2M2)'), Has('Shotgun')), Or(Has('Chaingun'), Has('Plasma gun')))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> Refinery (E2M3) Main", player),
        And(And(Has('Refinery (E2M3)'), Has('Shotgun')), Or(Has('Chaingun'), Has('Plasma gun')))
    )
    ...
    world.set_rule(
        ...
        And(Has('Chaingun'), Has('Command Center (E2M5)'), Has('Plasma gun'), Has('Shotgun'))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> Halls of the Damned (E2M6) Main", player),
        And(Has('Chaingun'), Has('Halls of the Damned (E2M6)'), Has('Plasma gun'), Has('Shotgun'))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> Spawning Vats (E2M7) Main", player),
        And(Has('Chaingun'), Has('Plasma gun'), Has('Rocket launcher'), Has('Shotgun'), Has('Spawning Vats (E2M7)'))
    )
    ...
    world.set_rule(
        ...
        And(And(Has('Chaingun'), Has('Fortress of Mystery (E2M9)'), Has('Shotgun')), Or(Has('BFG9000'), Has('Plasma gun'), Has('Rocket launcher')))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Chaingun'), Has('Shotgun')), Has('Slough of Despair (E3M2)'))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> Pandemonium (E3M3) Main", player),
        And(And(Has('Chaingun'), Has('Pandemonium (E3M3)'), Has('Shotgun')), Or(Has('BFG9000'), Has('Plasma gun'), Has('Rocket launcher')))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> House of Pain (E3M4) Main", player),
        And(And(Has('Chaingun'), Has('House of Pain (E3M4)'), Has('Shotgun')), Or(Has('BFG9000'), Has('Plasma gun'), Has('Rocket launcher')))
    )
    ...
    world.set_rule(
        ...
        And(Has('Chaingun'), Has('Mt. Erebus (E3M6)'), Has('Shotgun'))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> Limbo (E3M7) Main", player),
        And(And(Has('Chaingun'), Has('Limbo (E3M7)'), Has('Shotgun')), Or(Has('BFG9000'), Has('Plasma gun'), Has('Rocket launcher')))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> Dis (E3M8) Main", player),
        And(And(Has('Chaingun'), Has('Dis (E3M8)'), Has('Shotgun')), Or(Has('BFG9000'), Has('Plasma gun'), Has('Rocket launcher')))
    )

    world.set_rule(
        multiworld.get_entrance("Hub -> Warrens (E3M9) Main", player),
        And(And(Has('Chaingun'), Has('Plasma gun'), Has('Shotgun'), Has('Warrens (E3M9)')), Or(Has('BFG9000'), Has('Rocket launcher')))
    )
    ...
    world.set_rule(
        ...
        Or(Has('Chaingun'), Has('Shotgun'))
    )

    world.set_rule(
        multiworld.get_entrance("Command Control (E1M4) Main -> Command Control (E1M4) Blue", player),
        Or(Has('Command Control (E1M4) - Blue keycard'), Has('Command Control (E1M4) - Yellow keycard'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Computer Station (E1M7) - Red keycard'), Has('Computer Station (E1M7) - Yellow keycard'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Chaingun'), Has('Rocket launcher'), Has('Shotgun'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Chaingun'), Has('Plasma gun'), Has('Shotgun'))
    )

    world.set_rule(
        multiworld.get_entrance("Halls of the Damned (E2M6) Main -> Halls of the Damned (E2M6) Blue Yellow Red", player),
        And(Has('Halls of the Damned (E2M6) - Blue skull key'), Has('Halls of the Damned (E2M6) - Red skull key'), Has('Halls of the Damned (E2M6) - Yellow skull key'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Spawning Vats (E2M7) - Blue keycard'), Has('Spawning Vats (E2M7) - Red keycard'))
    )
    ...
    world.set_rule(
        ...
        And(And(Has('Chaingun'), Has('Shotgun')), Or(Has('BFG9000'), Has('Plasma gun'), Has('Rocket launcher')))
    )
