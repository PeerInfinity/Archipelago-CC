"""
Access rules for Landstalker - The Treasures of King Nole Test.
...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        ((Has("Blue Jewel")) & (Has("Green Jewel")) & (Has("Purple Jewel")) & (Has("Red Jewel")) & (Has("Yellow Jewel"))) & (True_())
    )
    ...
    world.set_rule(
        ...
        ((Has("Gola's Fang")) & (Has("Gola's Horn")) & (Has("Gola's Nail"))) & (True_())
    )
    ...
    world.set_rule(
        ...
        ((Has("Axe Magic")) & (Has("Lantern"))) & (True_())
    )
