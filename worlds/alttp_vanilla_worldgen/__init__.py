"""
A Link to the Past Vanilla WorldGen world implementation for Archipelago.
...
from .Items import item_table, ItemData, ALinktothePastVanillaWorldGenItem
from .Locations import location_table, ALinktothePastVanillaWorldGenLocation
from .Options import ALinktothePastVanillaWorldGenOptions
...
class ALinktothePastVanillaWorldGenWeb(WebWorld):
    """Web interface for A Link to the Past Vanilla WorldGen."""
    theme = "grass"
...
class ALTTPWorld(RuleWorldMixin, World):
    ...
    game: ClassVar[str] = "A Link to the Past Vanilla WorldGen"
    web: ClassVar[WebWorld] = ALinktothePastVanillaWorldGenWeb()
            ...
            if classification_counts:
                ...
                for classification_name, class_count in classification_counts.items():
                    ...
                    for _ in range(class_count):
                        item = ALinktothePastVanillaWorldGenItem(
                            item_name,
                            classification,
                            item_data.id,
                            self.player
    ...
    def create_item(self, name: str) -> Item:
        ...
        if classification_counts:
            ...
            item = ALinktothePastVanillaWorldGenItem(name, classification, data.id, self.player)
        else:
            item = ALinktothePastVanillaWorldGenItem(name, data.classification, data.id, self.player)
        if data.hint_text:
