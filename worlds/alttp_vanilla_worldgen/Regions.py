"""
Region definitions for A Link to the Past Vanilla WorldGen.
...
from .Locations import location_table, ALinktothePastVanillaWorldGenLocation
...
def create_regions(multiworld: MultiWorld, player: int) -> None:
    ...
    for location_name, location_data in location_table.items():
        ...
        location = ALinktothePastVanillaWorldGenLocation(
            player,
            location_name,
    ...
    _create_entrance(regions["Menu"], regions["Hyrule Castle Secret Entrance"], "Uncle S&Q")
