"""
Location definitions for ChocolateChipCookies WorldGen.
...
class ChocolateChipCookiesWorldGenLocation(Location):
    """Location class for ChocolateChipCookies WorldGen."""
