...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        And(Has('Creamed Mixture'), Has('Flour Mixture'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Electric Mixer'), Has('Mixing Bowls'), Has('Softened Butter'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Cookie Dough'), Has('Prepared Sheets'))
    )

    world.set_rule(
        multiworld.get_location("Bake for 9-11 Minutes", player),
        And(Has('Preheated Oven'), Has('Shaped Cookies'))
    )
