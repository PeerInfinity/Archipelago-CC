...
class BakingAdventureWorld(RuleWorldMixin, World):
    ...
    original_seed_placements: ClassVar[Dict[str, str]] = {
        "Gather Mixing Bowls": "Creamed Mixture",
        "Get Electric Mixer": "Flour Mixture",
        "Find Measuring Tools": "Softened Butter",
        "Preheat Oven to 375F": "Cookie Dough",
        "Line Baking Sheets": "Shaped Cookies",
        "Soften Butter": "Mixing Bowls",
        "Cream Butter and Sugars": "Basic Dough",
        "Add Eggs": "Measured Flour",
        "Add Vanilla": "Baked Cookies",
        "Measure Flour": "Preheated Oven",
        "Add Baking Soda and Salt": "Electric Mixer",
        "Gradually Mix Dry into Wet": "Prepared Sheets",
        "Fold in Chocolate Chips": "Measuring Tools",
        "Scoop Dough onto Sheets": "Butter Sugar Base",
        "Bake for 9-11 Minutes": "Egg Mixture",
        "Cool on Wire Rack": "Victory",
    }
