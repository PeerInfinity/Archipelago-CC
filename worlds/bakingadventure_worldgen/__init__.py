"""
ChocolateChipCookies WorldGen world implementation for Archipelago.
...
from .Items import item_table, ChocolateChipCookiesWorldGenItem
from .Locations import location_table, ChocolateChipCookiesWorldGenLocation
from .Options import ChocolateChipCookiesWorldGenOptions
...
class ChocolateChipCookiesWorldGenWorld(RuleWorldMixin, World):
    ...
    web: ClassVar[WebWorld] = ChocolateChipCookiesWorldGenWeb()
    ...
    def generate_basic(self) -> None:
        ...
        if victory_location.item is None:
            victory_item = ChocolateChipCookiesWorldGenItem(
                "Victory",
    ...
    def create_item(self, name: str) -> Item:
        ...
        return ChocolateChipCookiesWorldGenItem(name, data.classification, data.id, self.player)
