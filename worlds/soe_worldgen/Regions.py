"""
Region definitions for Secret of Evermore WorldGen.
...
def create_regions(multiworld: MultiWorld, player: int) -> None:
    ...
    for location_name, location_data in location_table.items():
        ...
        location = SecretofEvermoreWorldGenLocation(
            player,
            location_name,
    ...
    # Create entrances
    _create_entrance(regions["Menu"], regions["Ingame"], "New Game")
