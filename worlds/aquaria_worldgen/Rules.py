...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        And(Or(And(Has('Dual Form'), Has('Li and Li Song')), Has('Energy Form')), Has('Bind Song'))
    )

    world.set_rule(
        multiworld.get_entrance("Home Waters, Nautilus nest to Home Waters, behind rock", player),
        Or(And(Has('Dual Form'), Has('Li and Li Song')), Has('Energy Form'))
    )
    ...
    world.set_rule(
        ...
        And(Or(And(Has('Dual Form'), Has('Li and Li Song')), Has('Energy Form')), Has('Fish Form'))
    )
    ...
    world.set_rule(
        ...
        Or(Has('Arnassi Armor'), Has('Beast Form'))
    )

    world.set_rule(
        multiworld.get_entrance("Open Waters top right area to Open Waters top right area, Mithalas entrance", player),
        Or(HasAny('Baby Blaster', 'Baby Nautilus', 'Baby Piranha', 'Beast Form', 'Energy Form', 'Li and Li Song'), Has('Bind Song'))
    )
    ...
    world.set_rule(
        ...
        Or(Has('Baby Dumbo'), Has('Sun Form'))
    )
    ...
    world.set_rule(
        ...
        And(Or(Has('Arnassi Armor'), Has('Beast Form')), Or(Or(And(Has('Dual Form'), Has('Li and Li Song')), Has('Energy Form')), Has('Nature Form')))
    )
    ...
    world.set_rule(
        ...
        And(Or(And(Has('Dual Form'), Has('Li and Li Song')), Has('Energy Form')), Has('Nature Form'))
    )
    ...
    world.set_rule(
        ...
        And(HasAny('Baby Blaster', 'Baby Nautilus', 'Baby Piranha', 'Beast Form', 'Energy Form', 'Li and Li Song', 'Nature Form'), Has('Beast Form'))
    )
    ...
    world.set_rule(
        ...
        And(Or(And(Has('Dual Form'), Has('Li and Li Song')), Has('Energy Form')), Has('Bind Song'), Has('Fish Form'), Has('Nature Form'))
    )
    ...
    world.set_rule(
        ...
        Or(Or(And(Has('Dual Form'), Has('Li and Li Song')), Has('Energy Form')), Has('Fish Form'))
    )
    ...
    world.set_rule(
        ...
        And(Or(And(Has('Dual Form'), Has('Li and Li Song')), Has('Energy Form')), Has('Beast Form'))
    )
    ...
    world.set_rule(
        ...
        And(Or(And(Has('Dual Form'), Has('Li and Li Song')), Has('Energy Form')), Has('Beast Form'), Has('Sun Form'))
    )

    world.set_rule(
        multiworld.get_entrance("The Veil bottom left area to The Veil bottom left area, in the sunken ship", player),
        And(Has('Bind Song'), Has('Fish Form'))
    )
    ...
    world.set_rule(
        ...
        Or(And(Has('Bind Song'), Has('Has Sun Crystal')), Or(Has('Baby Dumbo'), Has('Sun Form')))
    )

    world.set_rule(
        multiworld.get_entrance("Sun Temple right area to Sun Temple left area entrance", player),
        Or(Or(Has('Baby Dumbo'), Has('Sun Form')), Has('Bind Song'))
    )
    ...
    world.set_rule(
        ...
        Or(And(Has('Beast Form'), Has('Energy Form')), And(Has('Dual Form'), Has('Li and Li Song')))
    )
    ...
    world.set_rule(
        ...
        And(Has('Spirit Form'), Has('Sun Form'))
    )

    world.set_rule(
        multiworld.get_entrance("Abyss right area to First Secret area", player),
        And(Or(And(Has('Dual Form'), Has('Li and Li Song')), Has('Energy Form')), Has('Bind Song'), Has('Spirit Form'), Has('Sun Form'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Bind Song'), Has('Nature Form'))
    )
    ...
    world.set_rule(
        ...
        And(Or(And(Has('Dual Form'), Has('Li and Li Song')), Has('Energy Form')), Has('Beast Form'), Has('Bind Song'), Has('Sun Form'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Dual Form'), Has('Li and Li Song'))
    )
    ...
    world.set_rule(
        ...
        And(And(Has('Dual Form'), Has('Li and Li Song')), Has('Bind Song'), Has('Energy Form'), Has('Sun Form'))
    )
    ...
    world.set_rule(
        ...
        And(Or(And(Has('Dual Form'), Has('Li and Li Song')), Has('Energy Form')), Has('Bind Song'), Has('Nature Form'))
    )

    world.set_rule(
        multiworld.get_entrance("Frozen Veil to Bubble Cave", player),
        Or(HasAny('Hot Soup', 'Hot Soup x 2'), Has('Beast Form'))
    )
    ...
    world.set_rule(
        ...
        Or(And(HasAny('Hot Soup', 'Hot Soup x 2'), Has('Beast Form')), Has('Fish Form'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Bind Song'), Has('Bind Song'))
    )
    ...
    world.set_rule(
        ...
        And(HasAny('Hot Soup', 'Hot Soup x 2'), Has('Beast Form'))
    )
    ...
    world.set_rule(
        ...
        Or(Or(And(HasAny('Hot Soup', 'Hot Soup x 2'), Has('Beast Form')), Has('Lumerean God beated')), Has('Sun God beated'))
    )
