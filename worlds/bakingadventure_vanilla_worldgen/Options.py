"""
Game options for Baking Adventure Vanilla WorldGen.
...
@dataclass
class BakingAdventureVanillaWorldGenOptions(PerGameCommonOptions):
    """Options for Baking Adventure Vanilla WorldGen."""
