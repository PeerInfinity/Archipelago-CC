"""
Location definitions for Baking Adventure Vanilla WorldGen.
...
class BakingAdventureVanillaWorldGenLocation(Location):
    """Location class for Baking Adventure Vanilla WorldGen."""
    game: str = "Baking Adventure Vanilla WorldGen"
