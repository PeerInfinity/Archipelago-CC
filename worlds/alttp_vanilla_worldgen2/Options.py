"""
Game options for A Link to the Past Vanilla WorldGen2.
...
@dataclass
class ALinktothePastVanillaWorldGen2Options(PerGameCommonOptions):
    """Options for A Link to the Past Vanilla WorldGen2."""
