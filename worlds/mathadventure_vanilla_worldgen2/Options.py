"""
Game options for Math Adventure Vanilla WorldGen2.
...
@dataclass
class MathAdventureVanillaWorldGen2Options(PerGameCommonOptions):
    """Options for Math Adventure Vanilla WorldGen2."""
