"""
Location definitions for Math Adventure Vanilla WorldGen2.
...
class MathAdventureVanillaWorldGen2Location(Location):
    """Location class for Math Adventure Vanilla WorldGen2."""
