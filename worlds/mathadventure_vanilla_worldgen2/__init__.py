"""
Math Adventure Vanilla WorldGen2 world implementation for Archipelago.
...
from .Items import item_table, ItemData, MathAdventureVanillaWorldGen2Item
from .Locations import location_table, MathAdventureVanillaWorldGen2Location
from .Options import MathAdventureVanillaWorldGen2Options
...
class MathAdventureVanillaWorldGen2Web(WebWorld):
    """Web interface for Math Adventure Vanilla WorldGen2."""
    theme = "ocean"
...
class MathAdventureWorld(RuleWorldMixin, World):
    ...
    game: ClassVar[str] = "Math Adventure Vanilla WorldGen2"
    web: ClassVar[WebWorld] = MathAdventureVanillaWorldGen2Web()

    options_dataclass = MathAdventureVanillaWorldGen2Options
    options: MathAdventureVanillaWorldGen2Options
            ...
            if classification_counts:
                ...
                for classification_name, class_count in classification_counts.items():
                    ...
                    for _ in range(class_count):
                        item = MathAdventureVanillaWorldGen2Item(
                            item_name,
                            classification,
                            item_data.id,
                            self.player
    ...
    def generate_basic(self) -> None:
        ...
        if victory_location.item is None:
            victory_item = MathAdventureVanillaWorldGen2Item(
                "Victory",
    ...
    def create_item(self, name: str) -> Item:
        ...
        item = MathAdventureVanillaWorldGen2Item(name, data.classification, data.id, self.player)
        if data.hint_text:
