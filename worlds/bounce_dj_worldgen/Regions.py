"""
Region definitions for Bounce DJ WorldGen.
...
def create_regions(multiworld: MultiWorld, player: int) -> None:
    ...
    # Create all regions
    region_names = ["Menu", "region_4_2", "region_3_3", "region_4_3", "region_3_4", "region_4_4"]
    ...
    for location_name, location_data in location_table.items():
        ...
        location = BounceDJWorldGenLocation(
            player,
            location_name,
    ...
    _create_entrance(regions["region_4_2"], regions["region_4_3"], "region_4_2__region_4_3")
    _create_entrance(regions["region_3_3"], regions["region_4_3"], "exit_E")
    _create_entrance(regions["region_4_3"], regions["region_4_4"], "exit_S")
    _create_entrance(regions["region_4_3"], regions["region_4_2"], "exit_N")
    _create_entrance(regions["region_4_3"], regions["region_3_3"], "region_3_3")
    _create_entrance(regions["region_3_4"], regions["region_4_4"], "region_4_4")
    _create_entrance(regions["region_4_4"], regions["region_3_4"], "exit_W")
    _create_entrance(regions["region_4_4"], regions["region_4_3"], "region_4_4__region_4_3")
