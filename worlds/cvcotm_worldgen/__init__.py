...
class CastlevaniaCircleoftheMoonWorldGenWorld(RuleWorldMixin, World):
    ...
    def __init__(self, multiworld: "MultiWorld", player: int):
        ...
        self.web = types.SimpleNamespace(theme='stone', tutorials=[{'name': 'Multiworld Setup Guide', 'description': 'A guide to setting up the Archipelago Castlevania: Circle of the Moon randomizer on your computer and connecting it to a multiworld.', 'language': 'English', 'file_name': 'setup_en.md', 'link': 'setup/en', 'authors': ['Liquid Cat']}])
