"""
DepGraph Skill Tree Vanilla WorldGen world implementation for Archipelago.
...
from .Items import item_table, ItemData, DepGraphSkillTreeVanillaWorldGenItem
from .Locations import location_table, DepGraphSkillTreeVanillaWorldGenLocation
from .Options import DepGraphSkillTreeVanillaWorldGenOptions
...
class DepGraphSkillTreeVanillaWorldGenWeb(WebWorld):
    """Web interface for DepGraph Skill Tree Vanilla WorldGen."""
    theme = "grass"
...
class DepGraphWorld(RuleWorldMixin, World):
    ...
    game: ClassVar[str] = "DepGraph Skill Tree Vanilla WorldGen"
    web: ClassVar[WebWorld] = DepGraphSkillTreeVanillaWorldGenWeb()

    options_dataclass = DepGraphSkillTreeVanillaWorldGenOptions
    options: DepGraphSkillTreeVanillaWorldGenOptions
    ...
    preset_label: ClassVar[str] = "skill_tree v"
    ...
    def __init__(self, multiworld: "MultiWorld", player: int):
        ...
        self.preset_label = 'skill_tree v'
            ...
            if classification_counts:
                ...
                for classification_name, class_count in classification_counts.items():
                    ...
                    for _ in range(class_count):
                        item = DepGraphSkillTreeVanillaWorldGenItem(
                            item_name,
                            classification,
                            item_data.id,
                            self.player
    ...
    def create_item(self, name: str) -> Item:
        ...
        item = DepGraphSkillTreeVanillaWorldGenItem(name, data.classification, data.id, self.player)
        return item
