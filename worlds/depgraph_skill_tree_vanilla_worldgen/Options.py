"""
Game options for DepGraph Skill Tree Vanilla WorldGen.
...
@dataclass
class DepGraphSkillTreeVanillaWorldGenOptions(PerGameCommonOptions):
    """Options for DepGraph Skill Tree Vanilla WorldGen."""
