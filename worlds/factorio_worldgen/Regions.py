"""
Region definitions for Factorio WorldGen.
...
def create_regions(multiworld: MultiWorld, player: int) -> None:
    ...
    for location_name, location_data in location_table.items():
        ...
        location = FactorioWorldGenLocation(
            player,
            location_name,
    ...
    # Create entrances
    _create_entrance(regions["Menu"], regions["Nauvis"], "MenuToStart")
