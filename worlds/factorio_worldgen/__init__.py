...
from .Items import item_table, ItemData, FactorioWorldGenItem
...
class Factorio(RuleWorldMixin, World):
    """
    ...
    canonical_placement_advancements: ClassVar[Dict[str, bool]] = {
        ...
        "AP-2-569": False,
        "Rocket Launch": True,
        "Automate automation-science-pack": True,
        "Automate chemical-science-pack": True,
        "Automate logistic-science-pack": True,
        "Automate military-science-pack": True,
        "Automate production-science-pack": True,
        "Automate utility-science-pack": True,
    }
    ...
    def create_item(self, name: str) -> Item:
        ...
        item = FactorioWorldGenItem(name, data.classification, data.id, self.player)
        if data.hint_text:
