...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        ((Has("Beast Form")) & (Has("Energy Form"))) | ((Has("Dual Form")) & (Has("Li and Li Song")))
    )
    ...
    world.set_rule(
        ...
        ((Has("Arnassi Armor")) | (Has("Beast Form"))) & ((((Has("Dual Form")) & (Has("Li and Li Song"))) | (Has("Energy Form"))) | (Has("Nature Form")))
    )
    ...
    world.set_rule(
        ...
        (Has("Bind Song")) & (Has("Nature Form"))
    )

    world.set_rule(
        multiworld.get_entrance("Energy Temple Idol room to Energy Temple fallen God room", player),
        (((Has("Dual Form")) & (Has("Li and Li Song"))) | (Has("Energy Form"))) & (Has("Fish Form"))
    )
    ...
    world.set_rule(
        ...
        (((Has("Dual Form")) & (Has("Li and Li Song"))) | (Has("Energy Form"))) & (Has("Bind Song")) & (Has("Nature Form"))
    )

    world.set_rule(
        multiworld.get_entrance("Energy Temple after boss path to Energy Temple fallen God room", player),
        ((Has("Dual Form")) & (Has("Li and Li Song"))) | (Has("Energy Form"))
    )

    world.set_rule(
        multiworld.get_entrance("Energy Temple bottom entrance to Home Waters, behind rock", player),
        (((Has("Dual Form")) & (Has("Li and Li Song"))) | (Has("Energy Form"))) & (Has("Bind Song"))
    )
    ...
    world.set_rule(
        ...
        (HasAny('Hot Soup', 'Hot Soup x 2')) | (Has("Beast Form"))
    )
    ...
    world.set_rule(
        ...
        (((Has("Dual Form")) & (Has("Li and Li Song"))) | (Has("Energy Form"))) & (Has("Bind Song")) & (Has("Fish Form")) & (Has("Nature Form"))
    )
    ...
    world.set_rule(
        ...
        (((Has("Dual Form")) & (Has("Li and Li Song"))) | (Has("Energy Form"))) & (Has("Beast Form"))
    )
    ...
    world.set_rule(
        ...
        HasAny('Baby Blaster', 'Baby Nautilus', 'Baby Piranha', 'Beast Form', 'Energy Form', 'Li and Li Song', 'Nature Form')
    )

    world.set_rule(
        multiworld.get_entrance("Mithalas Cathedral underground to Mithalas Cathedral end", player),
        (HasAny('Baby Blaster', 'Baby Nautilus', 'Baby Piranha', 'Beast Form', 'Energy Form', 'Li and Li Song', 'Nature Form')) & (Has("Beast Form"))
    )
    ...
    world.set_rule(
        ...
        (Has("Arnassi Armor")) | (Has("Beast Form"))
    )
    ...
    world.set_rule(
        ...
        (((Has("Dual Form")) & (Has("Li and Li Song"))) | (Has("Energy Form"))) & (Has("Nature Form"))
    )
    ...
    world.set_rule(
        ...
        (HasAny('Baby Blaster', 'Baby Nautilus', 'Baby Piranha', 'Beast Form', 'Energy Form', 'Li and Li Song')) | (Has("Bind Song"))
    )
    ...
    world.set_rule(
        ...
        ((Has("Bind Song")) & (Has("Has Sun Crystal"))) | ((Has("Baby Dumbo")) | (Has("Sun Form")))
    )
    ...
    world.set_rule(
        ...
        ((Has("Baby Dumbo")) | (Has("Sun Form"))) | (Has("Bind Song"))
    )

    world.set_rule(
        multiworld.get_entrance("Sunken City boss area to Sunken City left area", player),
        (((Has("Dual Form")) & (Has("Li and Li Song"))) | (Has("Energy Form"))) & (Has("Beast Form")) & (Has("Bind Song")) & (Has("Sun Form"))
    )
    ...
    world.set_rule(
        ...
        (Has("Dual Form")) & (Has("Li and Li Song"))
    )
    ...
    world.set_rule(
        ...
        ((Has("Dual Form")) & (Has("Li and Li Song"))) & (Has("Bind Song")) & (Has("Energy Form")) & (Has("Sun Form"))
    )
    ...
    world.set_rule(
        ...
        (((Has("Dual Form")) & (Has("Li and Li Song"))) | (Has("Energy Form"))) & (Has("Beast Form")) & (Has("Sun Form"))
    )
    ...
    world.set_rule(
        ...
        ((HasAny('Hot Soup', 'Hot Soup x 2')) & (Has("Beast Form"))) | (Has("Fish Form"))
    )
    ...
    world.set_rule(
        ...
        (((HasAny('Hot Soup', 'Hot Soup x 2')) & (Has("Beast Form"))) | (Has("Lumerean God beated"))) | (Has("Sun God beated"))
    )
