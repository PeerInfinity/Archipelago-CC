"""
Game options for Metamath Wilth Vanilla WorldGen.
...
@dataclass
class MetamathWilthVanillaWorldGenOptions(PerGameCommonOptions):
    """Options for Metamath Wilth Vanilla WorldGen."""
