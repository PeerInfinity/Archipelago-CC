"""
Adventure WorldGen2 world implementation for Archipelago.
...
from .Items import item_table, ItemData, AdventureWorldGen2Item
from .Locations import location_table, AdventureWorldGen2Location
from .Options import AdventureWorldGen2Options
...
class AdventureWorldGen2Web(WebWorld):
    """Web interface for Adventure WorldGen2."""
    theme = "dirt"
...
class AdventureWorld(RuleWorldMixin, World):
    ...
    game: ClassVar[str] = "Adventure WorldGen2"
    web: ClassVar[WebWorld] = AdventureWorldGen2Web()
    ...
    def generate_basic(self) -> None:
        ...
        if victory_location.item is None:
            victory_item = AdventureWorldGen2Item(
                "Victory",
    ...
    def create_item(self, name: str) -> Item:
        ...
        item = AdventureWorldGen2Item(name, data.classification, data.id, self.player)
        return item
