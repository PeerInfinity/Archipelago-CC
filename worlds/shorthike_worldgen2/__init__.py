"""
A Short Hike WorldGen2 world implementation for Archipelago.
...
from .Items import item_table, ItemData, AShortHikeWorldGen2Item
from .Locations import location_table, AShortHikeWorldGen2Location
from .Options import AShortHikeWorldGen2Options
...
class AShortHikeWorldGen2Web(WebWorld):
    """Web interface for A Short Hike WorldGen2."""
    theme = "ocean"
...
class ShortHikeWorld(RuleWorldMixin, World):
    ...
    game: ClassVar[str] = "A Short Hike WorldGen2"
    web: ClassVar[WebWorld] = AShortHikeWorldGen2Web()

    options_dataclass = AShortHikeWorldGen2Options
    options: AShortHikeWorldGen2Options
    ...
    def create_item(self, name: str) -> Item:
        ...
        item = AShortHikeWorldGen2Item(name, data.classification, data.id, self.player)
        return item
