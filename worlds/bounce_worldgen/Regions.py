"""
Region definitions for Bounce Demo WorldGen.
...
def create_regions(multiworld: MultiWorld, player: int) -> None:
    ...
    for location_name, location_data in location_table.items():
        ...
        location = BounceDemoWorldGenLocation(
            player,
            location_name,
    ...
    _create_entrance(regions["region_1_1"], regions["region_0_1"], "region_1_1__exit_W")
    _create_entrance(regions["region_2_1"], regions["region_2_0"], "region_2_1__exit_N")
    _create_entrance(regions["region_2_1"], regions["region_1_1"], "region_2_1__exit_W")
