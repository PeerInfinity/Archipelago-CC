"""
Bounce Demo WorldGen world implementation for Archipelago.
...
from .Items import item_table, ItemData, BounceDemoWorldGenItem
from .Locations import location_table, BounceDemoWorldGenLocation
from .Options import BounceDemoWorldGenOptions
...
class BounceDemoWorldGenWeb(WebWorld):
    """Web interface for Bounce Demo WorldGen."""
    theme = "ocean"
    game_info_languages: List[str] = ['en']
    tutorials = [
        Tutorial(
            "Multiworld Setup Guide",
            "A guide to setting up the Bounce Demo WorldGen world for Archipelago.",
            "English",
            "setup_en.md",
            "setup/en",
            ["Auto-generated"]
...
class ProcgenMazeWorld(RuleWorldMixin, World):
    """
    Bounce Demo WorldGen for Archipelago.
    
    Auto-generated world implementation.
    """

    game: ClassVar[str] = "Bounce Demo WorldGen"
    web: ClassVar[WebWorld] = BounceDemoWorldGenWeb()

    options_dataclass = BounceDemoWorldGenOptions
    options: BounceDemoWorldGenOptions
    ...
    item_name_groups: ClassVar[Dict[str, frozenset]] = {
        "Everything": frozenset(["Right arrow", "Left arrow", "Springs", "Blue platforms", "Victory", "Jetpacks"]),
    }
    ...
    canonical_placements: ClassVar[Dict[str, str]] = {
        "region_1_0__loc_arrow": "Right arrow",
        "region_2_0__loc_easy": "Left arrow",
        "region_2_0__loc_easy2": "Springs",
        "region_0_1__loc_right": "Blue platforms",
        "region_0_1__loc_left": "Victory",
        "region_1_1__loc_spring": "Jetpacks",
    }
    ...
    canonical_placement_advancements: ClassVar[Dict[str, bool]] = {
        "region_1_0__loc_arrow": True,
        "region_2_0__loc_easy": True,
        "region_2_0__loc_easy2": True,
        "region_0_1__loc_right": True,
        "region_0_1__loc_left": True,
        "region_1_1__loc_spring": True,
    }
    ...
    def __init__(self, multiworld: "MultiWorld", player: int):
        ...
        self.world_description = 'Bounce Demo WorldGen for Archipelago.\n\nAuto-generated world implementation.'
    ...
    def create_item(self, name: str) -> Item:
        ...
        item = BounceDemoWorldGenItem(name, data.classification, data.id, self.player)
        return item
