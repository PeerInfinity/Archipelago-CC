...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        And(Or(Compare(True_(), ">=", True_()), Has('Stage 1')), Has('Hidden Realm: Bazaar Between Time'))
    )

    world.set_rule(
        multiworld.get_entrance("OrderedStage_1 -> Abandoned Aqueduct", player),
        And(Or(Compare(True_(), ">=", True_()), Has('Stage 1')), Has('Abandoned Aqueduct'))
    )

    world.set_rule(
        multiworld.get_entrance("OrderedStage_1 -> Wetland Aspect", player),
        And(Or(Compare(True_(), ">=", True_()), Has('Stage 1')), Has('Wetland Aspect'))
    )

    world.set_rule(
        multiworld.get_entrance("OrderedStage_2 -> Rallypoint Delta", player),
        And(Or(Compare(True_(), ">=", True_()), Has('Stage 2')), Has('Rallypoint Delta'))
    )

    world.set_rule(
        multiworld.get_entrance("OrderedStage_2 -> Scorched Acres", player),
        And(Or(Compare(True_(), ">=", True_()), Has('Stage 2')), Has('Scorched Acres'))
    )

    world.set_rule(
        multiworld.get_entrance("OrderedStage_3 -> Abyssal Depths", player),
        And(Or(Compare(True_(), ">=", True_()), Has('Stage 3')), Has('Abyssal Depths'))
    )

    world.set_rule(
        multiworld.get_entrance("OrderedStage_3 -> Siren's Call", player),
        And(Or(Compare(True_(), ">=", True_()), Has('Stage 3')), Has("Siren's Call"))
    )

    world.set_rule(
        multiworld.get_entrance("OrderedStage_3 -> Sundered Grove", player),
        And(Or(Compare(True_(), ">=", True_()), Has('Stage 3')), Has('Sundered Grove'))
    )

    world.set_rule(
        multiworld.get_entrance("OrderedStage_4 -> Sky Meadow", player),
        And(Or(Compare(True_(), ">=", True_()), Has('Stage 4')), Has('Sky Meadow'))
    )
