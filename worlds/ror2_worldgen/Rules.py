...
from rule_builder import True_, False_, Compare, CountItem, Has
...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        ((Compare(CountItem("Progressive Stage"), ">=", 1)) | (Has("Stage 1"))) & (Has("Hidden Realm: Bazaar Between Time"))
    )

    world.set_rule(
        multiworld.get_entrance("OrderedStage_1 -> Abandoned Aqueduct", player),
        ((Compare(CountItem("Progressive Stage"), ">=", 1)) | (Has("Stage 1"))) & (Has("Abandoned Aqueduct"))
    )

    world.set_rule(
        multiworld.get_entrance("OrderedStage_1 -> Wetland Aspect", player),
        ((Compare(CountItem("Progressive Stage"), ">=", 1)) | (Has("Stage 1"))) & (Has("Wetland Aspect"))
    )

    world.set_rule(
        multiworld.get_entrance("OrderedStage_2 -> Rallypoint Delta", player),
        ((Compare(CountItem("Progressive Stage"), ">=", 2)) | (Has("Stage 2"))) & (Has("Rallypoint Delta"))
    )

    world.set_rule(
        multiworld.get_entrance("OrderedStage_2 -> Scorched Acres", player),
        ((Compare(CountItem("Progressive Stage"), ">=", 2)) | (Has("Stage 2"))) & (Has("Scorched Acres"))
    )

    world.set_rule(
        multiworld.get_entrance("OrderedStage_3 -> Abyssal Depths", player),
        ((Compare(CountItem("Progressive Stage"), ">=", 3)) | (Has("Stage 3"))) & (Has("Abyssal Depths"))
    )

    world.set_rule(
        multiworld.get_entrance("OrderedStage_3 -> Siren's Call", player),
        ((Compare(CountItem("Progressive Stage"), ">=", 3)) | (Has("Stage 3"))) & (Has("Siren's Call"))
    )

    world.set_rule(
        multiworld.get_entrance("OrderedStage_3 -> Sundered Grove", player),
        ((Compare(CountItem("Progressive Stage"), ">=", 3)) | (Has("Stage 3"))) & (Has("Sundered Grove"))
    )

    world.set_rule(
        multiworld.get_entrance("OrderedStage_4 -> Sky Meadow", player),
        ((Compare(CountItem("Progressive Stage"), ">=", 4)) | (Has("Stage 4"))) & (Has("Sky Meadow"))
    )
