...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        And(Has('Hidden Realm: A Moment, Fractured'), Has('Stage 5'))
    )

    world.set_rule(
        multiworld.get_entrance("OrderedStage_5 -> Commencement", player),
        And(Has('Commencement'), Has('Stage 5'))
    )
    ...
    world.set_rule(
        ...
        And(Has('Beads of Fealty'), Has('Hidden Realm: A Moment, Whole'))
    )

    world.set_rule(
        multiworld.get_entrance("Hidden Realm: Bazaar Between Time -> Void Fields", player),
        And(Has('Hidden Realm: Bazaar Between Time'), Has('Void Fields'))
    )
    # Location rules
    world.set_rule(
