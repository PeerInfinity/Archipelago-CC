...
from ._ext import True_, False_, And, Has, HelperCall, Or
...
def set_rules(world: "World") -> None:
    ...
    world.set_rule(
        ...
        HelperCall(helper_func=brooch, helper_name="brooch", body_rule=Has("Beanbean Brooch"))
    )
    ...
    world.set_rule(
        ...
        Or(HelperCall(helper_func=canDash, helper_name="canDash", body_rule=(Has("Red Pearl Bean")) & (Has("Firebrand"))), HelperCall(helper_func=super, helper_name="super", body_rule=Has("Hammers", 2)))
    )

    world.set_rule(
        multiworld.get_entrance("Sewers", player),
        HelperCall(helper_func=rose, helper_name="rose", body_rule=Has("Peasley's Rose"))
    )
    ...
    world.set_rule(
        ...
        Or(And(HelperCall(helper_func=castleTown, helper_name="castleTown"), HelperCall(helper_func=pieces, helper_name="pieces", body_rule=(Has("Beanstar Piece 1")) & (Has("Beanstar Piece 2")) & (Has("Beanstar Piece 3")) & (Has("Beanstar Piece 4"))), HelperCall(helper_func=rose, helper_name="rose", body_rule=Has("Peasley's Rose"))), HelperCall(helper_func=birdo_shop, helper_name="birdo_shop"))
    )
    ...
    world.set_rule(
        ...
        HelperCall(helper_func=fire, helper_name="fire", body_rule=Has("Firebrand"))
    )
    ...
    world.set_rule(
        ...
        Or(HelperCall(helper_func=canCrash, helper_name="canCrash", body_rule=(Has("Green Pearl Bean")) & (Has("Thunderhand"))), HelperCall(helper_func=super, helper_name="super", body_rule=Has("Hammers", 2)))
    )
    ...
    world.set_rule(
        ...
        And(HelperCall(helper_func=canDig, helper_name="canDig", body_rule=(Has("Green Goblet")) & (Has("Hammers"))), Or(HelperCall(helper_func=canCrash, helper_name="canCrash", body_rule=(Has("Green Pearl Bean")) & (Has("Thunderhand"))), HelperCall(helper_func=super, helper_name="super", body_rule=Has("Hammers", 2))))
    )
    ...
    world.set_rule(
        ...
        And(HelperCall(helper_func=canDig, helper_name="canDig", body_rule=(Has("Green Goblet")) & (Has("Hammers"))), HelperCall(helper_func=thunder, helper_name="thunder", body_rule=Has("Thunderhand")))
    )
    ...
    world.set_rule(
        ...
        HelperCall(helper_func=super, helper_name="super", body_rule=Has("Hammers", 2))
    )
    ...
    world.set_rule(
        ...
        And(HelperCall(helper_func=thunder, helper_name="thunder", body_rule=Has("Thunderhand")), HelperCall(helper_func=ultra, helper_name="ultra", body_rule=Has("Hammers", 3)))
    )
    ...
    world.set_rule(
        ...
        And(HelperCall(helper_func=canDig, helper_name="canDig", body_rule=(Has("Green Goblet")) & (Has("Hammers"))), Or(HelperCall(helper_func=canDash, helper_name="canDash", body_rule=(Has("Red Pearl Bean")) & (Has("Firebrand"))), HelperCall(helper_func=super, helper_name="super", body_rule=Has("Hammers", 2))))
    )
    ...
    world.set_rule(
        ...
        And(HelperCall(helper_func=super, helper_name="super", body_rule=Has("Hammers", 2)), HelperCall(helper_func=thunder, helper_name="thunder", body_rule=Has("Thunderhand")))
    )
    ...
    world.set_rule(
        ...
        And(HelperCall(helper_func=canDig, helper_name="canDig", body_rule=(Has("Green Goblet")) & (Has("Hammers"))), HelperCall(helper_func=super, helper_name="super", body_rule=Has("Hammers", 2)))
    )
    ...
    world.set_rule(
        ...
        And(HelperCall(helper_func=canDig, helper_name="canDig", body_rule=(Has("Green Goblet")) & (Has("Hammers"))), HelperCall(helper_func=teehee, helper_name="teehee"))
    )
    ...
    world.set_rule(
        ...
        And(HelperCall(helper_func=castleTown, helper_name="castleTown"), HelperCall(helper_func=pieces, helper_name="pieces", body_rule=(Has("Beanstar Piece 1")) & (Has("Beanstar Piece 2")) & (Has("Beanstar Piece 3")) & (Has("Beanstar Piece 4"))), HelperCall(helper_func=rose, helper_name="rose", body_rule=Has("Peasley's Rose")), HelperCall(helper_func=thunder, helper_name="thunder", body_rule=Has("Thunderhand")))
    )
    ...
    world.set_rule(
        ...
        And(HelperCall(helper_func=canDig, helper_name="canDig", body_rule=(Has("Green Goblet")) & (Has("Hammers"))), HelperCall(helper_func=ultra, helper_name="ultra", body_rule=Has("Hammers", 3)))
    )
    ...
    world.set_rule(
        ...
        HelperCall(helper_func=neon, helper_name="neon", body_rule=(Has("Blue Neon Egg")) & (Has("Red Neon Egg")) & (Has("Green Neon Egg")) & (Has("Yellow Neon Egg")) & (Has("Purple Neon Egg")) & (Has("Orange Neon Egg")) & (Has("Azure Neon Egg")))
    )
