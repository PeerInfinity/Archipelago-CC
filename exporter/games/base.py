...
class BaseGameExportHandler:
    ...
    def _is_worldgen_world(self, world) -> bool:
        ...
        WorldGen worlds have their module path containing '_worldgen'.
        They store computed attributes in _worldgen_settings.json and don't have
        the same runtime attributes as original worlds.

        Args:
            world: The world object to check
