...
class BaseGameExportHandler:
    ...
    def __init__(self, world=None):
        ...
        self._is_worldgen: Optional[bool] = None

    def _is_worldgen_world(self, world=None) -> bool:
        """Check if this is a worldgen world (generated by world_generator).

        Worldgen worlds have module paths ending with '_worldgen' (e.g., 'worlds.paint_worldgen').
        These worlds have their own generated rules and may need special handling.
        ...
        if self._is_worldgen is not None:
        ...
        self._is_worldgen = module_path.endswith('_worldgen') or '_worldgen.' in module_path
        return self._is_worldgen
