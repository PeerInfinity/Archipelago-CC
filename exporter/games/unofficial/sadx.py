...
SUB_LEVEL_DATA: Dict[str, Dict[int, List[str]]] = {
    ...
    "Sky Chase Act 1 (Sub-Level - Mission B)": {
        0: [TAILS, SONIC], 1: [TAILS, SONIC], 2: [TAILS, SONIC], 3: [TAILS, SONIC], 4: [TAILS, SONIC]
    },
    "Sky Chase Act 1 (Sub-Level - Mission A)": {
        0: [TAILS, SONIC], 1: [TAILS, SONIC], 2: [TAILS, SONIC], 3: [TAILS, SONIC], 4: [TAILS, SONIC]
    },
    "Sky Chase Act 2 (Sub-Level - Mission B)": {
        0: [TAILS, SONIC], 1: [TAILS, SONIC], 2: [TAILS, SONIC], 3: [TAILS, SONIC], 4: [TAILS, SONIC]
    },
    "Sky Chase Act 2 (Sub-Level - Mission A)": {
        0: [TAILS, SONIC], 1: [TAILS, SONIC], 2: [TAILS, SONIC], 3: [TAILS, SONIC], 4: [TAILS, SONIC]
    },
}
...
SUB_LEVEL_AREAS = {
    ...
    "Sky Chase Act 1 (Sub-Level - Mission B)": "SkyChase1",
    "Sky Chase Act 1 (Sub-Level - Mission A)": "SkyChase1",
    "Sky Chase Act 2 (Sub-Level - Mission B)": "SkyChase2",
    "Sky Chase Act 2 (Sub-Level - Mission A)": "SkyChase2",
}
...
class SADXGameExportHandler(GenericGameExportHandler):
    ...
    def post_process_data(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        logger.debug(f"SADX post_process_data expanded {expanded_count} location rules")
        return data
