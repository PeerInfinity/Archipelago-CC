...
class ALttPGameExportHandler(GenericGameExportHandler):
    ...
    def post_process_location_data(
        ...
        """
        # Check if this is a Kakariko Well superbunny location in glitch mode
        ...
        if (region_name == 'Kakariko Well (top)' and
            ...
            if glitches_required in glitch_modes:
                ...
                # simplified to True_ because in glitch modes, if you can reach the region,
    ...
    def _is_complex_bunny_rule(self, rule: Dict[str, Any]) -> bool:
        ...
        """
        # Check for Or rule (either format)
