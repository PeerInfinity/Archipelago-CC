...
class LandstalkerGameExportHandler(GenericGameExportHandler):
    ...
    - Region visit tracking with event_visited_ events
    - _landstalker_has_visited_regions helper expansion
    - Region object conversion in closure variables
    """
    ...
    def expand_rule(self, rule: Dict[str, Any], _depth: int = 0) -> Dict[str, Any]:
        ...
        This method handles Landstalker-specific patterns:
        - all_of with unresolved iterator for region visit checks
        - item_check with binary_op for event_visited_ + region.code
        - _landstalker_has_visited_regions helper expansion

        The has_all(set([items])) pattern is handled by the base class.
        """
