...
The timer's controls (a Begin/Stop button, a Quick Check button, a progress bar and the check counts) appear inside this panel once the Timer service attaches its UI.
