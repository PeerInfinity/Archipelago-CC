...
- [Loops Cost Debugger](./loopsCostDebugger.md) (`loopsCostDebugger`) — step-through debugger for the loop-cost generation algorithm. See also the [loop-cost engine disambiguation](../developer/procgen/gotchas.md#two-loop-cost-engines-one-store).
