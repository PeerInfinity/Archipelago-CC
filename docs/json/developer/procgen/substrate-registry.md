...
| `sidecarFields` | 18 keys | 6 keys | 7 keys | 7 keys | 18 keys | 7 keys | 5 keys | 9 keys |
...
| Field | `maze` | `flash` | `bounce` | `runner` | `text_adventure` | `flash_seedling` | `jta` | `omsi` |
|---|---|---|---|---|---|---|---|---|
| `exitSides` | — | — | {keys, relabel} | {keys, relabel} | — | — | — | — |
