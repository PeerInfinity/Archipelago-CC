...
**226 instruments** live in `scripts/procgen/`, by prefix: `probe-` 54 (21 browser) · `verify-` 49 (30 browser) · `plan-` 33 (1 browser) · `check-` 24 (18 browser) · `census-` 9 · `dump-` 6 · `sweep-` 6 · `make-` 5 · `recon-` 5 · `region-` 5 · `solve-` 5 · `generate-` 4 · `extract-` 3 · `attribute-` 2 · `audit-` 2 · `export-` 2 (1 browser) · `batch-` 1 · `build-` 1 · `find-` 1 · `harvest-` 1 · `measure-` 1 · `mine-` 1 · no prefix 1 · `prove-` 1 · `run-` 1 · `show-` 1 · `stamp-` 1 · `survey-` 1.

71 of them drive a real browser; 135 accept at least one `--flag`; 58 are cited by one of these documents; and 0 open with no comment at all.
