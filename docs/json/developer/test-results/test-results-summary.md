...
- **Multiplayer Test:** 30/78 passed (38.5%)
- **Multiworld Test:** 29/78 passed (37.2%)

### Combined Test Results

- **Templates passing all 4 tests:** 22/79 (27.8%)
...
|-----------|--------------|-----------|------------------|-----------------|-----------------|------------------|
| A Hat in Time | ❌ Failed | ❌ Failed | ❌ Failed | ✅ Passed | ⚫ | ⚫ |
...
| Heretic | ✅ Passed | ❌ Failed | ✅ Passed | ✅ Passed | ⚫ | ⚫ |
| Hylics 2 | ✅ Passed | ✅ Passed | ✅ Passed | ✅ Passed | ⚫ | ⚫ |
| Inscryption | ❌ Failed | ❌ Failed | ❌ Failed | ✅ Passed | ⚫ | ⚫ |
...
| Mega Man 2 | ❌ Failed | ❌ Failed | ❌ Failed | ✅ Passed | ⚫ | ⚫ |
...
| VVVVVV | ✅ Passed | ❌ Failed | ✅ Passed | ✅ Passed | ⚫ | ⚫ |
...
|-----------|----------------------------------|-------------------------------|
| A Link to the Past | [119/152 passed](./test-results-multitemplate-minimal.md#a-link-to-the-past) | [56/90 passed](./test-results-multitemplate-full.md#a-link-to-the-past) |
