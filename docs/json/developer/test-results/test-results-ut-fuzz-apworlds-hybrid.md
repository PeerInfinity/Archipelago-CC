...
- **Expected Passes:** 60 (passes hybrid mode per config)
- **Unexpected Passes:** 7 (expected to fail but passed)
- **Expected Failures:** 34 (doesn't pass hybrid mode per config)
