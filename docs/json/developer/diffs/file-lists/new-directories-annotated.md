...
- `worlds/metamath_canth_vanilla_worldgen/` (10 files)
- `worlds/metamath_canth_worldgen/` (10 files)
- `worlds/metamath_vanilla_worldgen/` (10 files)
- `worlds/metamath_wilth_vanilla_worldgen/` (10 files)
- `worlds/metamath_wilth_worldgen/` (10 files)
...
**Total:** 88 new directories containing 2593 files
