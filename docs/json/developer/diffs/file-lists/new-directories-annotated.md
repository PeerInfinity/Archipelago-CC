...
## Auto-Generated World Directories (63)

These directories are generated by the World Generator from JSON rules files.

<details>
<summary>Show 63 worldgen directories</summary>
...
- `worlds/bounce_dj_worldgen/` (11 files)
- `worlds/bounce_mixed_worldgen/` (11 files)
- `worlds/bounce_sphere_worldgen/` (11 files)
- `worlds/bounce_worldgen/` (10 files)
...
- `worlds/procgen_maze_worldgen/` (10 files)
...
**Total:** 94 new directories containing 3189 files
