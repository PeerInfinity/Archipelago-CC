...
-   `frontend/modules/gameStatePanel/index.js`: The module's entry point for registration.
-   `frontend/modules/gameStatePanel/gameStatePanelUI.js`: The UI class that renders the panel's content.
...
-   **`eventBus`**:
    -   `gameState:regionChanged`: This is the primary trigger for the panel to update its content. It listens for this event to know when to fetch and display the new current region.
