/**
 * Per-obstacle gating verifier (bounce's verifyObstacles.js shape).
 *
 ...
 *     construction.
 *
 * Conservative: the underlying reachability never over-claims (canRun is
 ...
 * "hard error in verify, never silent drop" channel.
 */
    ...
    for (const goal of goals) {
        ...
        goal.paths.forEach((path, i) => {
            ...
            for (const obstacleId of path.obstacles) {
                ...
                if (def.runner_ability) physicsAbilities.push(def.runner_ability);
            }
