...
| `swf_inject.mjs` | `SWFRecomp-CC/tools/divergence/swf_inject.mjs` — the canonical browser injector (replaced our provisional `swfPatch.js`) | verbatim copy; byte-identity vs `inject_tracer.py` pinned by `scripts/procgen/check-dj-swf-patch.mjs` |
