...
These types are generated by the Python exporter but have limited or no frontend support:

| Type | Description | Status |
|------|-------------|--------|
| `negate` | Unary minus operation (e.g., `-value`) | Generated when operand is non-constant; not evaluated in frontend |
| `formatted_value` | Individual formatted part of an f-string | Used internally within `f_string` type |
