...
|---|---|---|---|
| **`bounce.md`** — bounce substrate: physics model, zone generator, braid regimes, canJump solver, deriveRules verification, renderers/dj loader | `dj-metroidvania-v2.md`, `dj-measurements/`, `dj-loader-integration-spec.md`, parts of `topdown-bounce-obstacle-refactor.md` | ~19 | nearly all of `bounceDemo/*` (physics, generator, canJump, deriveRules, level, sideExits, suppression, apRules, gameCore, fixtures, djReal/README), `procgenPipelineEngine.js`, `scripts/procgen/dump-bounce-level.js` |
...
| **`playback-and-debugging.md`** — playback bot, PlaybackController proxies, control bar/clock, forward simulator, region reports | `playback-bot-refactor.md`, `async-playback-bot.md`, `debugging-tools.md`, `shared-simulator-core.md` | ~11 | `playbackBot/*`, `textAdventureSubstrateWrapper/playbackProxy.js`, `shared/playbackControlBar.js`, `shared/playbackClock.js`, `shared/simulatorCore.js`, `shared/procgen/forwardSimulator.js`, `mazeRoomVisualizer.js`, `mazeRoomEditor.js` |
